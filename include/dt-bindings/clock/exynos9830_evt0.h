...
/* NUMBER FOR NPU0 DRIVER STARTS FROM 30 */
#define	CLK_NPU0_BASE	(30)
#define	UMUX_CLKCMU_NPU_BUS	(CLK_NPU0_BASE + 0)
#define	GATE_NPUD_UNIT0	(CLK_NPU0_BASE + 1)
#define	GATE_NPUD_UNIT1	(CLK_NPU0_BASE + 2)
#define	DOUT_CLK_NPU_BUSP	(CLK_NPU0_BASE + 3)

/* NUMBER FOR NPU1 DRIVER STARTS FROM 50 */
#define	CLK_NPU1_BASE	(50)
...
#define	GATE_SS_SSPCORE	(CLK_SSP_BASE + 2)
...
#define	GATE_SYSMMU_TNR_QCH_S1	(CLK_TNR_BASE + 3)
#define	GATE_SYSMMU_TNR_QCH_S2	(CLK_TNR_BASE + 4)
...
#define	UMUX_CLKCMU_VRA_STR	(CLK_VRA_BASE + 1)
#define	GATE_VRA	(CLK_VRA_BASE + 2)
#define	GATE_SYSMMU_VRA_QCH_S1	(CLK_VRA_BASE + 3)
#define	GATE_SYSMMU_VRA_QCH_S2	(CLK_VRA_BASE + 4)
#define	GATE_STR	(CLK_VRA_BASE + 5)
...
#define	GATE_DNS_C2COM	(CLK_DNS_BASE + 2)
...
/* NUMBER FOR DSP0 DRIVER STARTS FROM 580 */
#define	CLK_DSP0_BASE	(580)
...
#define	GATE_IP_NPUC_ACLK	(CLK_DNC_BASE + 4)
#define	GATE_IP_NPUC_PCLK	(CLK_DNC_BASE + 5)
...
#define	GATE_SIPU_IPP_C2	(CLK_IPP_BASE + 2)
...
#define	UMUX_CLKCMU_MCSC_MEIP	(CLK_MCSC_BASE + 1)
#define	UMUX_CLKCMU_MCSC_GDC	(CLK_MCSC_BASE + 2)
#define	GATE_C2AGENT_MCSC	(CLK_MCSC_BASE + 3)
#define	GATE_GDC	(CLK_MCSC_BASE + 4)
#define	GATE_GDC_C2	(CLK_MCSC_BASE + 5)
#define	GATE_ITSC	(CLK_MCSC_BASE + 6)
#define	GATE_MCSC	(CLK_MCSC_BASE + 7)
#define	GATE_MCSC_C2	(CLK_MCSC_BASE + 8)
#define	GATE_MEIP	(CLK_MCSC_BASE + 9)
#define	GATE_MEIP_C2	(CLK_MCSC_BASE + 10)
