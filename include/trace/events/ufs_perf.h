#undef TRACE_SYSTEM
#define TRACE_SYSTEM ufs_perf

#if !defined(_TRACE_UFS_PERF_H) || defined(TRACE_HEADER_MULTI_READ)
#define _TRACE_UFS_PERF_H
...
TRACE_EVENT(ufs_perf_stat,
		...
		DEFINE_EVENT(ufs_perf_one_int, ufs_perf_lock,
