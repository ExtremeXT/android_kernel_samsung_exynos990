 ...
 *
 * Exynos9830  gpio and clock configurations
 *
...
struct is_clk is_clk_list[] = {
	...
	REGISTER_CLK("UMUX_CLKCMU_MCSC_MEIP"),
	REGISTER_CLK("UMUX_CLKCMU_MCSC_GDC"),
	REGISTER_CLK("GATE_GDC"),
	REGISTER_CLK("GATE_ITSC"),
	REGISTER_CLK("GATE_MCSC"),
	REGISTER_CLK("GATE_MEIP"),
...
static int exynos9830_is_print_clk(struct device *dev)
{
	...
	is_get_rate_dt(dev, "UMUX_CLKCMU_MCSC_MEIP");
	is_get_rate_dt(dev, "GATE_GDC");
	is_get_rate_dt(dev, "GATE_ITSC");
	is_get_rate_dt(dev, "GATE_MCSC");
	is_get_rate_dt(dev, "GATE_MEIP");
	...
	is_get_rate_dt(dev, "MUX_CIS_CLK0");
	is_get_rate_dt(dev, "MUX_CIS_CLK1");
	is_get_rate_dt(dev, "MUX_CIS_CLK2");
	is_get_rate_dt(dev, "MUX_CIS_CLK3");
	is_get_rate_dt(dev, "MUX_CIS_CLK4");
	is_get_rate_dt(dev, "MUX_CIS_CLK5");
...
int exynos9830_is_dump_clk(struct device *dev)
{
	...
	is_dump_rate_dt(dev, "UMUX_CLKCMU_MCSC_MEIP");
	is_dump_rate_dt(dev, "GATE_GDC");
	is_dump_rate_dt(dev, "GATE_ITSC");
	is_dump_rate_dt(dev, "GATE_MCSC");
	is_dump_rate_dt(dev, "GATE_MEIP");
	...
	is_dump_rate_dt(dev, "MUX_CIS_CLK0");
	is_dump_rate_dt(dev, "MUX_CIS_CLK1");
	is_dump_rate_dt(dev, "MUX_CIS_CLK2");
	is_dump_rate_dt(dev, "MUX_CIS_CLK3");
	is_dump_rate_dt(dev, "MUX_CIS_CLK4");
	is_dump_rate_dt(dev, "MUX_CIS_CLK5");
...
int exynos9830_is_clk_on(struct device *dev)
{
	...
	is_enable(dev, "UMUX_CLKCMU_MCSC_MEIP");
	is_enable(dev, "UMUX_CLKCMU_MCSC_GDC");
	is_enable(dev, "GATE_GDC");
	is_enable(dev, "GATE_ITSC");
	is_enable(dev, "GATE_MCSC");
	is_enable(dev, "GATE_MEIP");
	if (debug_clk > 1)
...
int exynos9830_is_clk_off(struct device *dev)
{
	...
	is_disable(dev, "UMUX_CLKCMU_MCSC_MEIP");
	is_disable(dev, "UMUX_CLKCMU_MCSC_GDC");
	is_disable(dev, "GATE_GDC");
	is_disable(dev, "GATE_ITSC");
	is_disable(dev, "GATE_MCSC");
	is_disable(dev, "GATE_MEIP");
