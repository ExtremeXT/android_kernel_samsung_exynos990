...
static struct is_field sysreg_mcsc_fields[SYSREG_MCSC_REG_FIELD_CNT] = {
	{"SW_RESETn_LHM_AST_GLUE_OTF3_ITPMCSC", 7, 1, RW, 0x1}, /* MCSC_USER_CON0 */
	{"SW_RESETn_LHM_AST_GLUE_OTF2_ITPMCSC", 6, 1, RW, 0x1},
	{"SW_RESETn_LHM_AST_GLUE_OTF1_ITPMCSC", 5, 1, RW, 0x1},
	{"SW_RESETn_LHM_AST_GLUE_OTF0_ITPMCSC", 4, 1, RW, 0x1},
	{"TYPE_LHM_AST_GLUE_OTF3_ITPMCSC", 3, 1, RW, 0x0},
	{"TYPE_LHM_AST_GLUE_OTF2_ITPMCSC", 2, 1, RW, 0x0},
	{"TYPE_LHM_AST_GLUE_OTF1_ITPMCSC", 1, 1, RW, 0x0},
	{"TYPE_LHM_AST_GLUE_OTF0_ITPMCSC", 0, 1, RW, 0x0},
	{"AxCACHE_GDC", 12, 4, RW, 0x2}, /* MCSC_USER_CON1 */
	{"AxCACHE_MEIP", 8, 4, RW, 0x2},
	{"AxCACHE_MCSC", 4, 4, RW, 0x2},
	{"AxCACHE_ITSC", 0, 4, RW, 0x2},
	{"C2AGENT_M6S4_C2AGENT_SW_RESET", 11, 1, RW, 0x1}, /* MCSC_USER_CON2 */
	{"MCSC_C2COM_SW_RESET", 10, 1, RW, 0x1},
	{"Enable_OTF_IN_LHM_AST_D3_ITPMCS", 9, 1, RW, 0x1},
	{"Enable_OTF_IN_LHM_AST_D2_ITPMCS", 8, 1, RW, 0x1},
	{"Enable_OTF_IN_LHM_AST_D1_ITPMCS", 7, 1, RW, 0x1},
	{"Enable_OTF_IN_LHM_AST_D0_ITPMCS", 6, 1, RW, 0x1},
	{"LHM_AST_INT_MEIPMCSC", 5, 1, RW, 0x0},
	{"LHS_AST_INT_MEIPMCSC", 4, 1, RW, 0x0},
	{"LHM_AST_INT_GDCMEIP", 3, 1, RW, 0x0},
	{"LHS_AST_INT_GDCMEIP", 2, 1, RW, 0x0},
	{"LHS_AST_VO_MCSCCSIS", 1, 1, RW, 0x0},
	{"LHM_AST_VO_TNRMCSC", 0, 1, RW, 0x0},
};
...
int is_hw_request_irq(void *itfc_data, int hw_id)
{
	...
	switch (hw_id) {
	case DEV_HW_3AA0:
		ret = __is_hw_request_irq(itf_hwip, "3a0-0", INTR_HWIP1, __is_isr1_3aa0);
		ret = __is_hw_request_irq(itf_hwip, "3a0-1", INTR_HWIP2, __is_isr2_3aa0);
		ret = __is_hw_request_irq(itf_hwip, "meip0", INTR_HWIP4, __is_isr4_3aa0);
		ret = __is_hw_request_irq(itf_hwip, "3a0dma0", INTR_HWIP5, __is_isr5_3aa0);
		ret = __is_hw_request_irq(itf_hwip, "3a0dma1", INTR_HWIP6, __is_isr6_3aa0);
		break;
	case DEV_HW_3AA1:
		ret = __is_hw_request_irq(itf_hwip, "3a1-0", INTR_HWIP1, __is_isr1_3aa1);
		ret = __is_hw_request_irq(itf_hwip, "3a1-1", INTR_HWIP2, __is_isr2_3aa1);
		ret = __is_hw_request_irq(itf_hwip, "meip1", INTR_HWIP4, __is_isr4_3aa1);
		ret = __is_hw_request_irq(itf_hwip, "3a1dma0", INTR_HWIP5, __is_isr5_3aa1);
		ret = __is_hw_request_irq(itf_hwip, "3a1dma1", INTR_HWIP6, __is_isr6_3aa1);
		break;
	case DEV_HW_3AA2:
		ret = __is_hw_request_irq(itf_hwip, "3a2-0", INTR_HWIP1, __is_isr1_3aa2);
		ret = __is_hw_request_irq(itf_hwip, "3a2-1", INTR_HWIP2, __is_isr2_3aa2);
		ret = __is_hw_request_irq(itf_hwip, "3a2dma0", INTR_HWIP5, __is_isr5_3aa2);
		ret = __is_hw_request_irq(itf_hwip, "3a2dma1", INTR_HWIP6, __is_isr6_3aa2);
		break;
	case DEV_HW_ISP0:
		ret = __is_hw_request_irq(itf_hwip, "itp0", INTR_HWIP1, __is_isr1_itp0);
		ret = __is_hw_request_irq(itf_hwip, "itp0", INTR_HWIP2, __is_isr2_itp0);
		ret = __is_hw_request_irq(itf_hwip, "tnr0", INTR_HWIP4, __is_isr4_itp0);
		break;
	case DEV_HW_MCSC0:
		ret = __is_hw_request_irq(itf_hwip, "mcs0", INTR_HWIP1, __is_isr1_mcs0);
		break;
	default:
		probe_err("hw_id(%d) is invalid", hw_id);
		return -EINVAL;
	...
	case DEV_HW_MCSC0:
		{
			...
			cap->hw_ver = HW_SET_VERSION(8, 0, 0, 0);
			cap->max_output = 4;
			cap->max_djag = 1;
			cap->max_cac = 1;
			cap->max_uvsp = 2;
			...
			cap->out_post[3] = MCSC_CAP_SUPPORT;
...
int blk_dns_mux_control(struct is_device_ischain *device, u32 value)
{
	...
	/* fix DNS1 <- IPP1 for EVT0 */
	dns_val = is_hw_set_field_value(dns_val,
				&sysreg_dns_fields[SYSREG_F_GLUEMUX_DNS1_VAL], 0);
	dns_val = is_hw_set_field_value(dns_val,
...
int blk_itp_otfenable_control(struct is_device_ischain *device, u32 value)
{
	...
	itp_val = is_hw_set_field_value(itp_val,
				&sysreg_itp_fields[SYSREG_F_Enable_OTF_OUT_ITPDNS], value);
	itp_val = is_hw_set_field_value(itp_val,
				&sysreg_itp_fields[SYSREG_F_Enable_OTF0_OUT_ITPMCSC], value);
	itp_val = is_hw_set_field_value(itp_val,
				&sysreg_itp_fields[SYSREG_F_Enable_OTF1_OUT_ITPMCSC], value);
	itp_val = is_hw_set_field_value(itp_val,
				&sysreg_itp_fields[SYSREG_F_Enable_OTF2_OUT_ITPMCSC], value);
	itp_val = is_hw_set_field_value(itp_val,
				&sysreg_itp_fields[SYSREG_F_Enable_OTF3_OUT_ITPMCSC], value);
...
int blk_mcsc_otfenable_control(struct is_device_ischain *device, u32 value)
{
	...
	mcsc_val = is_hw_set_field_value(mcsc_val,
				&sysreg_mcsc_fields[SYSREG_F_Enable_OTF_IN_LHM_AST_D3_ITPMCSC], value);
	mcsc_val = is_hw_set_field_value(mcsc_val,
				&sysreg_mcsc_fields[SYSREG_F_Enable_OTF_IN_LHM_AST_D2_ITPMCSC], value);
	mcsc_val = is_hw_set_field_value(mcsc_val,
				&sysreg_mcsc_fields[SYSREG_F_Enable_OTF_IN_LHM_AST_D1_ITPMCSC], value);
	mcsc_val = is_hw_set_field_value(mcsc_val,
				&sysreg_mcsc_fields[SYSREG_F_Enable_OTF_IN_LHM_AST_D0_ITPMCSC], value);
...
int is_hw_ischain_enable(struct is_device_ischain *device)
{
	...
	ret = blk_ipp_mux0_control(device, 1);
	if (!ret)
		merr("blk_ipp_mux0_control is failed (%d)\n", device, ret);
	ret = blk_ipp_mux1_control(device, 1);
	if (!ret)
		merr("blk_ipp_mux1_control is failed (%d)\n", device, ret);
