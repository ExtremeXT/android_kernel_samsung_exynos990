 ...
 *
 * Exynos9830 pablo parameter definitions
 *
...
#define IS_REGION_VER 160  /* IS REGION VERSION 1.60 */
...
struct isp_param {
	...
	struct param_dma_input		vdma1_input;	/* dma1_input */
	struct param_dma_input		vdma3_input;	/* tnr merger dma only */
