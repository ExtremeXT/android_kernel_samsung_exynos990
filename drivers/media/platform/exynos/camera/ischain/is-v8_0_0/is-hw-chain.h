...
#ifndef IS_HW_CHAIN_V8_0_H
#define IS_HW_CHAIN_V8_0_H
...
enum sysreg_mcsc_reg_field {
	SYSREG_F_SW_RESETn_LHM_AST_GLUE_OTF3_ITPMCSC,
	SYSREG_F_SW_RESETn_LHM_AST_GLUE_OTF2_ITPMCSC,
	SYSREG_F_SW_RESETn_LHM_AST_GLUE_OTF1_ITPMCSC,
	SYSREG_F_SW_RESETn_LHM_AST_GLUE_OTF0_ITPMCSC,
	SYSREG_F_TYPE_LHM_AST_GLUE_OTF3_ITPMCSC,
	SYSREG_F_TYPE_LHM_AST_GLUE_OTF2_ITPMCSC,
	SYSREG_F_TYPE_LHM_AST_GLUE_OTF1_ITPMCSC,
	SYSREG_F_TYPE_LHM_AST_GLUE_OTF0_ITPMCSC,
	SYSREG_F_AxCACHE_GDC,
	SYSREG_F_AxCACHE_MEIP,
	SYSREG_F_AxCACHE_MCSC,
	SYSREG_F_AxCACHE_ITSC,
	SYSREG_F_C2AGENT_M6S4_C2AGENT_SW_RESET,
	SYSREG_F_MCSC_C2COM_SW_RESET,
	SYSREG_F_Enable_OTF_IN_LHM_AST_D3_ITPMCSC,
	SYSREG_F_Enable_OTF_IN_LHM_AST_D2_ITPMCSC,
	SYSREG_F_Enable_OTF_IN_LHM_AST_D1_ITPMCSC,
	SYSREG_F_Enable_OTF_IN_LHM_AST_D0_ITPMCSC,
	SYSREG_F_LHM_AST_INT_MEIPMCSC,
	SYSREG_F_LHS_AST_INT_MEIPMCSC,
	SYSREG_F_LHM_AST_INT_GDCMEIP,
	SYSREG_F_LHS_AST_INT_GDCMEIP,
	SYSREG_F_LHS_AST_VO_MCSCCSIS,
	SYSREG_F_LHM_AST_VO_TNRMCSC,
...
#define IORESOURCE_ITSC		13	/* EVT0 only */
#define IORESOURCE_ITP1		14	/* EVT0 only */
#define IORESOURCE_DNS1		15	/* EVT0 only */

#define GROUP_SENSOR_MAX_WIDTH	9280
#define GROUP_SENSOR_MAX_HEIGHT	6944
#define GROUP_PDP_MAX_WIDTH	9280
#define GROUP_PDP_MAX_HEIGHT	6944
#define GROUP_3AA_MAX_WIDTH	13696
#define GROUP_3AA_MAX_HEIGHT	6944
...
/* ME/DRC DMA: 2.5MB */
#define TAAISP_MEDRC_SIZE	(0x00580000)
/* ORBMCH DMA: Not Used */
#define TAAISP_ORBMCH_SIZE	(0)
/* TNR DMA: */
/* Image: ((Max width * Max height * 14 / 8) + 32) * 2 * 3 */
/* Weight: ((Max width * Max height / 2 / 2) + 32) * 2 * 3 */
#define TAAISP_TNR_SIZE		(0x9283132)
/* CLAHE DMA: Not Used */
#define IS_CLAHE_SIZE		(0)
/* VRA: 8MB */
#define IS_VRA_SIZE		(0x00800000) /* FIXME: no need */
/* DDK HEAP: 60MB */
