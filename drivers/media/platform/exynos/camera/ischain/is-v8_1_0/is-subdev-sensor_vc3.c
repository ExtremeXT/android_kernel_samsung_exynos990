...
static int is_sensor_vc3_cfg(struct is_subdev *leader,
	void *device_data,
...
static int is_sensor_vc3_tag(struct is_subdev *subdev,
	void *device_data,
...
const struct is_subdev_ops is_subdev_ssvc3_ops = {
	.bypass			= NULL,
	.cfg			= is_sensor_vc3_cfg,
	.tag			= is_sensor_vc3_tag,
};
