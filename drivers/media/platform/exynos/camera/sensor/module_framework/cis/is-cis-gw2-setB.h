...
#ifndef IS_CIS_3M5_SET_B_H
#define IS_CIS_3M5_SET_B_H
#if 0
#include "is-cis.h"
#include "is-cis-3m5.h"

/* S5K3M5SM_EVT0.1_Ver_1.3_20170920.xlsx */
const u32 sensor_3m5_setfile_B_Global[] = {
	0xFCFC, 0x4000, 0x02,
	0x6010, 0x0001, 0x02,
...
/*  EXTCLK 26Mhz */
const u32 sensor_3m5_setfile_B_4032x3024_30fps[] = {
	0xFCFC, 0x4000, 0x02,
	0x6214, 0x7971, 0x02,
	0x6218, 0x7150, 0x02,
	0x0136, 0x1A00, 0x02,
...
const u32 sensor_3m5_setfile_B_4032x2268_30fps[] = {
	0xFCFC, 0x4000, 0x02,
	0x6214, 0x7971, 0x02,
	0x6218, 0x7150, 0x02,
	0x0136, 0x1A00, 0x02,
...
const u32 sensor_3m5_setfile_B_4032x1960_30fps[] = {
	0xFCFC, 0x4000, 0x02,
	0x6214, 0x7971, 0x02,
	0x6218, 0x7150, 0x02,
	0x0136, 0x1A00, 0x02,
...
const u32 sensor_3m5_setfile_B_3024x3024_30fps[] = {
	0xFCFC, 0x4000, 0x02,
	0x6214, 0x7971, 0x02,
	0x6218, 0x7150, 0x02,
	0x0136, 0x1A00, 0x02,
...
const u32 sensor_3m5_setfile_B_2016x1512_30fps[] = {
	0xFCFC, 0x4000, 0x02,
	0x6214, 0x7971, 0x02,
	0x6218, 0x7150, 0x02,
	0x0136, 0x1A00, 0x02,
...
const u32 sensor_3m5_setfile_B_1504x1504_30fps[] = {
	0xFCFC, 0x4000, 0x02,
	0x6214, 0x7971, 0x02,
	0x6218, 0x7150, 0x02,
	0x0136, 0x1A00, 0x02,
...
const u32 sensor_3m5_setfile_B_1920x1080_60fps[] = {
	0xFCFC, 0x4000, 0x02,
	0x6214, 0x7971, 0x02,
	0x6218, 0x7150, 0x02,
	0x0136, 0x1A00, 0x02,
...
const u32 sensor_3m5_setfile_B_1344x756_120fps[] = {
	0xFCFC, 0x4000, 0x02,
	0x6214, 0x7971, 0x02,
	0x6218, 0x7150, 0x02,
	0x0136, 0x1A00, 0x02,
...
const u32 sensor_3m5_setfile_B_2016x1134_30fps[] = {
	0xFCFC, 0x4000, 0x02,
	0x6214, 0x7971, 0x02,
	0x6218, 0x7150, 0x02,
	0x0136, 0x1A00, 0x02,
...
const struct sensor_pll_info_compact sensor_3m5_pllinfo_B_4032x3024_30fps = {
...
const struct sensor_pll_info_compact sensor_3m5_pllinfo_B_4032x2268_30fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	1196000000, /* mipi_datarate */
	481000000,  /* pclk  = VT pix CLK * 4(this value is different by cis) */
	0x0D48, /* frame_length_lines */
...
const struct sensor_pll_info_compact sensor_3m5_pllinfo_B_4032x1960_30fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	1196000000, /* mipi_datarate */
	481000000,  /* pclk  = VT pix CLK * 4(this value is different by cis) */
	0x0D48, /* frame_length_lines */
...
const struct sensor_pll_info_compact sensor_3m5_pllinfo_B_3024x3024_30fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	1196000000, /* mipi_datarate */
	481000000,  /* pclk  = VT pix CLK * 4(this value is different by cis) */
	0x0D48, /* frame_length_lines */
...
const struct sensor_pll_info_compact sensor_3m5_pllinfo_B_2016x1512_30fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	1196000000, /* mipi_datarate */
	481000000,  /* pclk  = VT pix CLK * 4(this value is different by cis) */
...
const struct sensor_pll_info_compact sensor_3m5_pllinfo_B_1504x1504_30fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	1196000000, /* mipi_datarate */
	481000000,  /* pclk  = VT pix CLK * 4(this value is different by cis) */
...
const struct sensor_pll_info_compact sensor_3m5_pllinfo_B_1920x1080_60fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	1196000000, /* mipi_datarate */
	481000000,  /* pclk  = VT pix CLK * 4(this value is different by cis) */
...
const struct sensor_pll_info_compact sensor_3m5_pllinfo_B_1344x756_120fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	1196000000, /* mipi_datarate */
	481000000,  /* pclk  = VT pix CLK * 4(this value is different by cis) */
...
const struct sensor_pll_info_compact sensor_3m5_pllinfo_B_2016x1134_30fps = {
	EXT_CLK_Mhz * 1000 * 1000, /* ext_clk */
	1196000000, /* mipi_datarate */
	481000000,  /* pclk  = VT pix CLK * 4(this value is different by cis) */
...
static const u32 *sensor_3m5_setfiles_B[] = {
	sensor_3m5_setfile_B_4032x3024_30fps,
	sensor_3m5_setfile_B_4032x2268_30fps,
	sensor_3m5_setfile_B_4032x1960_30fps,
	sensor_3m5_setfile_B_3024x3024_30fps,
	sensor_3m5_setfile_B_2016x1512_30fps,
	sensor_3m5_setfile_B_1504x1504_30fps,
	sensor_3m5_setfile_B_1920x1080_60fps,
	sensor_3m5_setfile_B_1344x756_120fps,
	sensor_3m5_setfile_B_2016x1134_30fps,
};

static const u32 sensor_3m5_setfile_B_sizes[] = {
	ARRAY_SIZE(sensor_3m5_setfile_B_4032x3024_30fps),
	ARRAY_SIZE(sensor_3m5_setfile_B_4032x2268_30fps),
	ARRAY_SIZE(sensor_3m5_setfile_B_4032x1960_30fps),
	ARRAY_SIZE(sensor_3m5_setfile_B_3024x3024_30fps),
	ARRAY_SIZE(sensor_3m5_setfile_B_2016x1512_30fps),
	ARRAY_SIZE(sensor_3m5_setfile_B_1504x1504_30fps),
	ARRAY_SIZE(sensor_3m5_setfile_B_1920x1080_60fps),
	ARRAY_SIZE(sensor_3m5_setfile_B_1344x756_120fps),
	ARRAY_SIZE(sensor_3m5_setfile_B_2016x1134_30fps),
};

static const struct sensor_pll_info_compact *sensor_3m5_pllinfos_B[] = {
	&sensor_3m5_pllinfo_B_4032x3024_30fps,
	&sensor_3m5_pllinfo_B_4032x2268_30fps,
	&sensor_3m5_pllinfo_B_4032x1960_30fps,
	&sensor_3m5_pllinfo_B_3024x3024_30fps,
	&sensor_3m5_pllinfo_B_2016x1512_30fps,
	&sensor_3m5_pllinfo_B_1504x1504_30fps,
	&sensor_3m5_pllinfo_B_1920x1080_60fps,
	&sensor_3m5_pllinfo_B_1344x756_120fps,
	&sensor_3m5_pllinfo_B_2016x1134_30fps,
};
#endif
#endif
