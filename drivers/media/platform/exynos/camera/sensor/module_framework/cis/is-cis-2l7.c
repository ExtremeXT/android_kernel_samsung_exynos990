...
#include "is-dt.h"
#include "is-cis-2l7.h"
#include "is-cis-2l7-setA.h"
#include "is-cis-2l7-setB.h"
...
int sensor_2l7_cis_check_rev(struct is_cis *cis)
{
	int ret = 0;
	u8 rev = 0;
...
int sensor_2l7_cis_mode_change(struct v4l2_subdev *subdev, u32 mode)
{
	...
	is_sensor_write16(cis->client, 0x6028, 0x4000);
	is_sensor_write16(cis->client, 0x602A, 0x30BC);
	is_sensor_write16(cis->client, 0x6F12, 0x012B);	//RAW10
#endif
...
int sensor_2l7_cis_set_exposure_time(struct v4l2_subdev *subdev, struct ae_param *target_exposure)
{
	...
	/* Long exposure */
	if (is_vender_enable_wdr(cis_data)) {
