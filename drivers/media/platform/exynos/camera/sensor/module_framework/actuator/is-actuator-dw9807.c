...
int sensor_dw9807_init(struct i2c_client *client, struct is_caldata_list_dw9807 *cal_data)
{
	int ret = 0;
	u8 i2c_data[2];
...
int sensor_dw9807_actuator_init(struct v4l2_subdev *subdev, u32 val)
{
	int ret = 0;
	struct is_actuator *actuator;
	struct is_caldata_list_dw9807 *cal_data = NULL;
	...
	cal_data = (struct is_caldata_list_dw9807 *)(cal_addr);
