...
static const struct of_device_id exynos_is_sensor_flash_rt5033_match[] = {
	{
		.compatible = "samsung,sensor-flash-rt5033",
	},
	{},
};
MODULE_DEVICE_TABLE(of, exynos_is_sensor_flash_rt5033_match);
...
static struct i2c_driver sensor_flash_rt5033_i2c_driver = {
	...
	.driver = {
		...
		.owner	= THIS_MODULE,
		.of_match_table = exynos_is_sensor_flash_rt5033_match
