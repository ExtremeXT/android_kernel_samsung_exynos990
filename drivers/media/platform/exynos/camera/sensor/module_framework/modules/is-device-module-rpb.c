...
static struct is_sensor_cfg config_module_rpb[] = {
	/* width, height, fps, settle, mode, lane, speed, interleave, pd_mode */
	IS_SENSOR_CFG(4656, 3520, 30, 0, 0, CSI_DATA_LANES_4, 1437, CSI_MODE_VC_DT, PD_MOD2,
	...
	IS_SENSOR_CFG(4656, 2656, 30, 0, 1, CSI_DATA_LANES_4, 1437, CSI_MODE_VC_DT, PD_MOD2,
		VC_IN(0, HW_FORMAT_RAW10, 4656, 2656), VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 4656, 2656),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	IS_SENSOR_CFG(4656, 3104, 30, 0, 2, CSI_DATA_LANES_4, 1437, CSI_MODE_VC_DT, PD_MOD2,
		VC_IN(0, HW_FORMAT_RAW10, 4656, 3104), VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 4656, 3104),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	IS_SENSOR_CFG(2320, 1312, 60, 0, 3, CSI_DATA_LANES_4, 2100, CSI_MODE_VC_DT, PD_MOD2,
		VC_IN(0, HW_FORMAT_RAW10, 2320, 1312), VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 2320, 1312),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	IS_SENSOR_CFG(1936, 1104, 480, 0, 4, CSI_DATA_LANES_4, 4498, CSI_MODE_VC_DT, PD_MOD2,
...
#ifdef CONFIG_OF
	is_module_parse_dt(dev, sensor_module_rpb_power_setpin);
#endif
...
static const struct of_device_id exynos_is_sensor_module_rpb_match[] = {
	{
		.compatible = "samsung,sensor-module-rpb",
	},
	{},
};
MODULE_DEVICE_TABLE(of, exynos_is_sensor_module_rpb_match);

static struct platform_driver sensor_module_rpb_driver = {
	.driver = {
		.name   = "FIMC-IS-SENSOR-MODULE-RPB",
		.owner  = THIS_MODULE,
		.of_match_table = exynos_is_sensor_module_rpb_match,
	}
};

static int __init is_sensor_module_rpb_init(void)
{
	int ret;
...
late_initcall(is_sensor_module_rpb_init);
