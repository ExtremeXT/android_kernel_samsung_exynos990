...
static struct is_sensor_cfg config_module_2p2[] = {
	/* 5328x3000@30fps */
	IS_SENSOR_CFG(5328, 3000, 30, 31, 0, CSI_DATA_LANES_4),
	/* 4000X3000@30fps */
	IS_SENSOR_CFG(4000, 3000, 30, 24, 1, CSI_DATA_LANES_4),
	/* 3008X3000@30fps */
	IS_SENSOR_CFG(3008, 3000, 30, 22, 2, CSI_DATA_LANES_4),
	/* 5328x3000@24fps */
	IS_SENSOR_CFG(5328, 3000, 24, 24, 3, CSI_DATA_LANES_4),
	/* 4000X3000@24fps */
	IS_SENSOR_CFG(4000, 3000, 24, 22, 4, CSI_DATA_LANES_4),
	/* 3008X3000@24fps */
	IS_SENSOR_CFG(3008, 3000, 24, 15, 5, CSI_DATA_LANES_4),
	/* 2664X1500@60fps */
	IS_SENSOR_CFG(2664, 1500, 60, 15, 6, CSI_DATA_LANES_4),
	/* 1328X748@120fps */
	IS_SENSOR_CFG(1328, 748, 120, 15, 8, CSI_DATA_LANES_4),

};

static struct is_vci vci_module_2p2[] = {
	{
...
static int __init sensor_module_2p2_probe(struct platform_device *pdev)
{
	...
	is_module_parse_dt(dev, sensor_module_2p2_power_setpin);
...
static const struct of_device_id exynos_is_sensor_module_2p2_match[] = {
	{
		.compatible = "samsung,sensor-module-2p2",
	},
	{},
};
MODULE_DEVICE_TABLE(of, exynos_is_sensor_module_2p2_match);

static struct platform_driver sensor_module_2p2_driver = {
	.driver = {
		.name   = "FIMC-IS-SENSOR-MODULE-2P2",
		.owner  = THIS_MODULE,
		.of_match_table = exynos_is_sensor_module_2p2_match,
	}
};

static int __init is_sensor_module_2p2_init(void)
{
	int ret;
...
late_initcall(is_sensor_module_2p2_init);
