...
static struct is_sensor_cfg config_module_2p8[] = {
			/* width, height, fps, settle, mode, lane, speed, interleave, pd_mode */
	IS_SENSOR_CFG(5328, 3000, 30, 0, 0, CSI_DATA_LANES_4, 1404, CSI_MODE_VC_DT, PD_NONE,
	...
	IS_SENSOR_CFG(4000, 3000, 30, 0, 1, CSI_DATA_LANES_4, 1118, CSI_MODE_VC_DT, PD_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 4000, 3000), VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_USER, 0, 0), VC_OUT(HW_FORMAT_USER, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	IS_SENSOR_CFG(3008, 3000, 30, 0, 2, CSI_DATA_LANES_4, 1014, CSI_MODE_VC_DT, PD_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 3008, 3000), VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_USER, 0, 0), VC_OUT(HW_FORMAT_USER, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	IS_SENSOR_CFG(2664, 1500, 60, 0, 3, CSI_DATA_LANES_4, 702, CSI_MODE_VC_DT, PD_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 2664, 1500), VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_USER, 0, 0), VC_OUT(HW_FORMAT_USER, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	IS_SENSOR_CFG(1328, 748, 120, 0, 4, CSI_DATA_LANES_4, 624, CSI_MODE_VC_DT, PD_NONE,
...
static int __init sensor_module_2p8_probe(struct platform_device *pdev)
{
	...
	is_module_parse_dt(dev, module_2p8_power_setpin[gpio_sel]);
...
static const struct of_device_id exynos_is_sensor_module_2p8_match[] = {
	{
...
MODULE_DEVICE_TABLE(of, exynos_is_sensor_module_2p8_match);

static struct platform_driver sensor_module_2p8_driver = {
	.driver = {
		.name   = "FIMC-IS-SENSOR-MODULE-2P8",
		.owner  = THIS_MODULE,
		.of_match_table = exynos_is_sensor_module_2p8_match,
	}
};

static int __init is_sensor_module_2p8_init(void)
{
	int ret;
...
late_initcall(is_sensor_module_2p8_init);
