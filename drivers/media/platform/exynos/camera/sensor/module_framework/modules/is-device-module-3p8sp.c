...
static struct is_sensor_cfg config_module_3p8sp[] = {
	/* 4608x3456@30fps */
	IS_SENSOR_CFG_EXT(4608, 3456, 30, 30, 0, CSI_DATA_LANES_4, 1365, 0, 0, 0),
	/* 2304x1728@30fps */
	IS_SENSOR_CFG_EXT(2304, 1728, 30, 15, 1, CSI_DATA_LANES_4, 715, 0, 0, 0),
};

static struct is_vci vci_module_3p8sp[] = {
	{
...
static int __init sensor_module_3p8sp_probe(struct platform_device *pdev)
{
	...
	is_module_parse_dt(dev, sensor_module_3p8sp_power_setpin);
...
static const struct of_device_id exynos_is_sensor_module_3p8sp_match[] = {
	{
		.compatible = "samsung,sensor-module-3p8sp",
	},
	{},
};
MODULE_DEVICE_TABLE(of, exynos_is_sensor_module_3p8sp_match);

static struct platform_driver sensor_module_3p8sp_driver = {
	.driver = {
		.name   = "FIMC-IS-SENSOR-MODULE-3P8SP",
		.owner  = THIS_MODULE,
		.of_match_table = exynos_is_sensor_module_3p8sp_match,
	}
};

static int __init is_sensor_module_3p8sp_init(void)
{
	int ret;
...
late_initcall(is_sensor_module_3p8sp_init);
