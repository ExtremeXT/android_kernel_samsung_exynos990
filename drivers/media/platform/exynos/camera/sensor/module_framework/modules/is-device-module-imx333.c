...
static struct is_sensor_cfg config_imx333[] = {
	/* 4032x3024@30fps */
	IS_SENSOR_CFG_EXT(4032, 3024,  30, 14, 0, CSI_DATA_LANES_4, 2145, 0, SET_VC(VC_MIPI_STAT, 4032, 14), 0),
	/* 4032x2268@30fps */
	IS_SENSOR_CFG_EXT(4032, 2268,  30, 14, 1, CSI_DATA_LANES_4, 2145, 0, SET_VC(VC_MIPI_STAT, 4032, 14), 0),
	/* 3024x3024@30fps */
	IS_SENSOR_CFG_EXT(3024, 3024,  30, 14, 2, CSI_DATA_LANES_4, 2145, 0, SET_VC(VC_MIPI_STAT, 3024, 19), 0),
	/* 4032x2268@60fps */
	IS_SENSOR_CFG_EXT(4032, 2268,  60, 21, 3, CSI_DATA_LANES_4, 2145, 0, SET_VC(VC_MIPI_STAT, 4032, 4), 0),
	/* 2016x1134@120fps */
	IS_SENSOR_CFG_EXT(2016, 1134, 120, 21, 4, CSI_DATA_LANES_4, 2145, 0, SET_VC(VC_MIPI_STAT, 2016, 8), 0),
	/* 2016x1134@240fps */
	IS_SENSOR_CFG_EXT(2016, 1134, 240, 21, 5, CSI_DATA_LANES_4, 2145, 0, SET_VC(VC_MIPI_STAT, 2016, 8), 0),
	/* 1008x 756@120fps */
	IS_SENSOR_CFG_EXT(1008,  756, 120, 21, 6, CSI_DATA_LANES_4, 2145, 0, SET_VC(VC_MIPI_STAT, 1008, 1), 0),
	/* 2016x 1512@30fps */
	IS_SENSOR_CFG_EXT(2016, 1512,  30, 14, 7, CSI_DATA_LANES_4, 2145, 0, SET_VC(VC_MIPI_STAT, 2016, 8), 0), 
	/* 1504x 1504@30fps */
	IS_SENSOR_CFG_EXT(1504, 1504,  30, 14, 8, CSI_DATA_LANES_4, 2145, 0, SET_VC(VC_MIPI_STAT, 1504, 11), 0),
	/* 2016x 1134@30fps */
	IS_SENSOR_CFG_EXT(2016, 1134,  30, 14, 9, CSI_DATA_LANES_4, 2145, 0, SET_VC(VC_MIPI_STAT, 2016, 8), 0),
	/* 4032x 1960@30fps */
	IS_SENSOR_CFG_EXT(4032, 1960,  30, 14, 10, CSI_DATA_LANES_4, 2145, 0, SET_VC(VC_MIPI_STAT, 4032, 14), 0),
};

static struct is_vci vci_imx333[] = {
	{
...
#ifdef CONFIG_OF
	is_module_parse_dt(dev, sensor_imx333_power_setpin);
#endif
...
static const struct of_device_id exynos_is_sensor_module_imx333_match[] = {
	{
		.compatible = "samsung,sensor-module-imx333",
	},
	{},
};
MODULE_DEVICE_TABLE(of, exynos_is_sensor_module_imx333_match);

static struct platform_driver sensor_module_imx333_driver = {
	.driver = {
		.name   = "FIMC-IS-SENSOR-MODULE-IMX333",
		.owner  = THIS_MODULE,
		.of_match_table = exynos_is_sensor_module_imx333_match,
	}
};

static int __init is_sensor_module_imx333_init(void)
{
	int ret;
...
late_initcall(is_sensor_module_imx333_init);
