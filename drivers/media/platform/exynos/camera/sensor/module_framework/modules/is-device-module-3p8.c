...
static struct is_sensor_cfg config_module_3p8[] = {
	/* 4624x3466@30fps */
	IS_SENSOR_CFG_EXT(4624, 3466, 30, 32, 0, CSI_DATA_LANES_4, 0, SET_VC(VC_TAIL_MODE_PDAF, 144, 864), 0, 0),
	/* 4624x2602@30fps */
	IS_SENSOR_CFG_EXT(4624, 2602, 30, 32, 1, CSI_DATA_LANES_4, 0, SET_VC(VC_TAIL_MODE_PDAF, 144, 640), 0, 0),
	/* 2312x1732@60fps */
	IS_SENSOR_CFG(2312, 1732, 60, 32, 2, CSI_DATA_LANES_4),
	/* 2312x1732@30fps */
	IS_SENSOR_CFG(2312, 1732, 30, 32, 3, CSI_DATA_LANES_4),
	/* 2312x1732@15fps */
	IS_SENSOR_CFG(2312, 1732, 15, 32, 4, CSI_DATA_LANES_4),
	/* 2312x1300@60fps */
	IS_SENSOR_CFG(2312, 1300, 60, 32, 5, CSI_DATA_LANES_4),
	/* 2312x1300@30fps */
	IS_SENSOR_CFG(2312, 1300, 30, 32, 6, CSI_DATA_LANES_4),
	/* 1152x864@120fps */
	IS_SENSOR_CFG(1152, 864, 120, 32, 7, CSI_DATA_LANES_4),
	/* 1152x648@120fps */
	IS_SENSOR_CFG(1152, 648, 120, 32, 8, CSI_DATA_LANES_4),
};

static struct is_vci vci_module_3p8[] = {
	{
...
static int __init sensor_module_3p8_probe(struct platform_device *pdev)
{
	...
	is_module_parse_dt(dev, module_3p8_power_setpin[exist_actuator]);
...
static const struct of_device_id exynos_is_sensor_module_3p8_match[] = {
	{
		.compatible = "samsung,sensor-module-3p8",
	},
	{},
};
MODULE_DEVICE_TABLE(of, exynos_is_sensor_module_3p8_match);

static struct platform_driver sensor_module_3p8_driver = {
	.driver = {
		.name   = "FIMC-IS-SENSOR-MODULE-3P8",
		.owner  = THIS_MODULE,
		.of_match_table = exynos_is_sensor_module_3p8_match,
	}
};

static int __init is_sensor_module_3p8_init(void)
{
	int ret;
...
late_initcall(is_sensor_module_3p8_init);
