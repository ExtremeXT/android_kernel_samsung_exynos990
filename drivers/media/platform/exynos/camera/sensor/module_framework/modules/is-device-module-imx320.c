...
static struct is_sensor_cfg config_module_imx320[] = {
#if 0
	/* 3280X2464@30fps */
	IS_SENSOR_CFG(3280, 2464, 30, 14, 0, CSI_DATA_LANES_2),
	/* 1304X980@30fps */
	IS_SENSOR_CFG(1304, 980, 30, 22, 2, CSI_DATA_LANES_2),
	/* 1304X980@15fps */
	IS_SENSOR_CFG(1304, 980, 15, 7, 3, CSI_DATA_LANES_2),
	/* 1304X980@10fps */
	IS_SENSOR_CFG(1304, 980, 10, 7, 4, CSI_DATA_LANES_2),
	/* 1304X980@7fps */
	IS_SENSOR_CFG(1304, 980, 7, 7, 5, CSI_DATA_LANES_2),
	/* 652X488@112fps */
	IS_SENSOR_CFG(652, 488, 112, 22, 1, CSI_DATA_LANES_2),
#else /* hack */
			/* width, height, fps, settle, mode, lane, speed, interleave, pd_mode */
	IS_SENSOR_CFG(3280, 2464, 30, 0, 0, CSI_DATA_LANES_2, 1358, CSI_MODE_VC_DT, PD_NONE,
	...
	IS_SENSOR_CFG(3280, 1232, 60, 0, 1, CSI_DATA_LANES_2, 1358, CSI_MODE_VC_DT, PD_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 3280, 1232), VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(0, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	IS_SENSOR_CFG(1640, 1232, 30, 0, 2, CSI_DATA_LANES_2, 718, CSI_MODE_VC_DT, PD_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 1640, 1232), VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(0, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	IS_SENSOR_CFG(1640, 1232, 60, 0, 3, CSI_DATA_LANES_2, 718, CSI_MODE_VC_DT, PD_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 1640, 1232), VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(0, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	IS_SENSOR_CFG(820, 616, 120, 138, 4, CSI_DATA_LANES_2, 718, CSI_MODE_VC_DT, PD_NONE,
...
static int __init sensor_module_imx320_probe(struct platform_device *pdev)
{
	...
	is_module_parse_dt(dev, sensor_module_imx320_power_setpin);
...
static const struct of_device_id exynos_is_sensor_module_imx320_match[] = {
	{
		.compatible = "samsung,sensor-module-imx320",
	},
	{},
};
MODULE_DEVICE_TABLE(of, exynos_is_sensor_module_imx320_match);

static struct platform_driver sensor_module_imx320_driver = {
	.driver = {
		.name   = "FIMC-IS-SENSOR-MODULE-IMX320",
		.owner  = THIS_MODULE,
		.of_match_table = exynos_is_sensor_module_imx320_match,
	}
};

static int __init is_sensor_module_imx320_init(void)
{
	int ret;
...
late_initcall(is_sensor_module_imx320_init);
