...
static struct is_sensor_cfg config_module_3p3[] = {
	/* 4624x3466@30fps */
	IS_SENSOR_CFG(4624, 3466, 30, 30, 0, CSI_DATA_LANES_4),
	/* 4624x3466@24fps */
	IS_SENSOR_CFG(4624, 3466, 24, 30, 1, CSI_DATA_LANES_4),
	/* 4624x2602@30fps */
	IS_SENSOR_CFG(4624, 2602, 30, 23, 2, CSI_DATA_LANES_4),
	/* 4624x2602@24fps */
	IS_SENSOR_CFG(4624, 2602, 24, 23, 3, CSI_DATA_LANES_4),
	/* 4240x3466@30fps */
	IS_SENSOR_CFG(4240, 3466, 30, 19, 4, CSI_DATA_LANES_4),
	/* 4624x3082@30fps */
	IS_SENSOR_CFG(4624, 3082, 30, 19, 5, CSI_DATA_LANES_4),
	/* 4336x3466@30fps */
	IS_SENSOR_CFG(4336, 3466, 30, 19, 6, CSI_DATA_LANES_4),
	/* 4624x2778@30fps */
	IS_SENSOR_CFG(4624, 2778, 30, 19, 7, CSI_DATA_LANES_4),
	/* 2312x1300@60fps */
	IS_SENSOR_CFG(2312, 1300, 60, 19, 8, CSI_DATA_LANES_4),
	/* 1152x864@120fps */
	IS_SENSOR_CFG(1152, 864, 120, 13, 9, CSI_DATA_LANES_4),
	/* 1152x648@120fps */
	IS_SENSOR_CFG(1152, 648, 120, 13, 10, CSI_DATA_LANES_4),
};

static struct is_vci vci_module_3p3[] = {
	{
...
static int sensor_module_3p3_power_setpin(struct device *dev,
...
static int __init sensor_module_3p3_probe(struct platform_device *pdev)
{
	...
	is_module_parse_dt(dev, sensor_module_3p3_power_setpin);
...
static const struct of_device_id exynos_is_sensor_module_3p3_match[] = {
	{
		.compatible = "samsung,sensor-module-3p3",
	},
	{},
};
MODULE_DEVICE_TABLE(of, exynos_is_sensor_module_3p3_match);

static struct platform_driver sensor_module_3p3_driver = {
	.driver = {
		.name   = "FIMC-IS-SENSOR-MODULE-3P3",
		.owner  = THIS_MODULE,
		.of_match_table = exynos_is_sensor_module_3p3_match,
	}
};

static int __init is_sensor_module_3p3_init(void)
{
	int ret;
...
late_initcall(is_sensor_module_3p3_init);
