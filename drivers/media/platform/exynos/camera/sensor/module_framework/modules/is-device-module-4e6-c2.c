...
static struct is_sensor_cfg config_module_4e6_c2[] = {
	/* 2608x1960@30fps */
	IS_SENSOR_CFG(2608, 1960, 30, 22, 0, CSI_DATA_LANES_2),
	IS_SENSOR_CFG(652, 488, 112, 22, 1, CSI_DATA_LANES_2),
};

static struct is_vci vci_module_4e6_c2[] = {
	{
...
static int sensor_module_4e6_c2_power_setpin(struct device *dev,
...
static int __init sensor_module_4e6_c2_probe(struct platform_device *pdev)
{
	...
	is_module_parse_dt(dev, sensor_module_4e6_c2_power_setpin);
...
static const struct of_device_id exynos_is_sensor_module_4e6_c2_match[] = {
	{
		.compatible = "samsung,sensor-module-4e6-c2",
	},
	{},
};
MODULE_DEVICE_TABLE(of, exynos_is_sensor_module_4e6_c2_match);

static struct platform_driver sensor_module_4e6_c2_driver = {
	.driver = {
		.name   = "FIMC-IS-SENSOR-MODULE-4E6-c2",
		.owner  = THIS_MODULE,
		.of_match_table = exynos_is_sensor_module_4e6_c2_match,
	}
};

static int __init is_sensor_module_4e6_c2_init(void)
{
	int ret;
...
late_initcall(is_sensor_module_4e6_c2_init);
