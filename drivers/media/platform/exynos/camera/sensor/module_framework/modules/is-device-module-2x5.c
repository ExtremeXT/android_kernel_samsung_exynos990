...
enum {
	...
	MODE_2156x2156_30,		/* 3 */
	MODE_2880x2156_120,		/* 4 */
	MODE_5760x4312_30,		/* 5 */
	MODE_5760x3240_30,		/* 6 */
	MODE_5760x2664_30,		/* 7 */
	MODE_4312x4312_30,		/* 8 */
	MODE_2880x2156_30_3DHDR,	/* 9 */
	MODE_END
};

static struct is_sensor_cfg config_module_2x5[] = {
	/* width, height, fps, settle, mode, lane, speed, interleave, pd_mode */
	/* 0: 2880x2156@30fps */
	IS_SENSOR_CFG(2880, 2156,  30, 0, 0, CSI_DATA_LANES_4, 2093, CSI_MODE_DT_ONLY, PD_NONE,
	...
	/* 1: 2880x1620@30fps */
	IS_SENSOR_CFG(2880, 1620,  30, 0, 1, CSI_DATA_LANES_4, 2093, CSI_MODE_DT_ONLY, PD_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 2880, 1620), VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 2: 2880x1332@30fps */
	IS_SENSOR_CFG(2880, 1332,  30, 0, 2, CSI_DATA_LANES_4, 2093, CSI_MODE_DT_ONLY, PD_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 2880, 1332), VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 3: 2156x2156@30fps */
	IS_SENSOR_CFG(2156, 2156,  30, 0, 3, CSI_DATA_LANES_4, 2093, CSI_MODE_DT_ONLY, PD_NONE,
		VC_IN(0, HW_FORMAT_RAW10,  2156, 2156), VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 4: 2880x2156@100fps FAST AE*/
	IS_SENSOR_CFG(2880, 2156, 100, 0, 4, CSI_DATA_LANES_4, 2093, CSI_MODE_DT_ONLY, PD_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 2880, 2156), VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 5: 5760x4312@30fps */
	IS_SENSOR_CFG(5760, 4312, 30, 0, 5, CSI_DATA_LANES_4, 2093, CSI_MODE_DT_ONLY, PD_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 5760, 4312), VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 6: 5760x3240@30fps */
	IS_SENSOR_CFG(5760,  3240, 30, 0, 6, CSI_DATA_LANES_4, 2093, CSI_MODE_DT_ONLY, PD_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 5760, 3240), VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 7: 5760x2664@30fps */
	IS_SENSOR_CFG(5760, 2664,  30, 0, 7, CSI_DATA_LANES_4, 2093, CSI_MODE_DT_ONLY, PD_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 5760, 2664), VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 8: 4312x4312@30fps */
	IS_SENSOR_CFG(4312, 4312,  30, 0, 8, CSI_DATA_LANES_4, 2093, CSI_MODE_DT_ONLY, PD_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 4312, 4312), VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)),
	/* 9: 2880x2156@30fps_3dhdr */
	/* IS_SENSOR_CFG(2880, 2156,  30, 0, 9, CSI_DATA_LANES_4, 2093, CSI_MODE_DT_ONLY, PD_NONE,
		VC_IN(0, HW_FORMAT_RAW10, 2880, 2156), VC_OUT(HW_FORMAT_RAW10, VC_NOTHING, 0, 0),
		VC_IN(1, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(2, HW_FORMAT_EMBEDDED_8BIT, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0),
		VC_IN(3, HW_FORMAT_UNKNOWN, 0, 0), VC_OUT(HW_FORMAT_UNKNOWN, VC_NOTHING, 0, 0)), */
...
int sensor_module_2x5_probe(struct platform_device *pdev)
{
	...
	is_module_parse_dt(dev, sensor_module_2x5_power_setpin);
...
static const struct of_device_id exynos_is_sensor_module_2x5_match[] = {
	{
		.compatible = "samsung,sensor-module-2x5",
	},
	{},
};
MODULE_DEVICE_TABLE(of, exynos_is_sensor_module_2x5_match);
...
static struct platform_driver sensor_module_2x5_driver = {
	...
	.driver = {
		...
		.owner  = THIS_MODULE,
		.of_match_table = exynos_is_sensor_module_2x5_match,
	}
};
