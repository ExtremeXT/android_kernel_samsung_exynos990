...
static struct is_sensor_cfg config_module_3m2[] = {
	/* 4144x3106@30fps */
	IS_SENSOR_CFG(4144, 3106, 30, 24, 0, CSI_DATA_LANES_4),
	/* 3112x3106@30fps */
	IS_SENSOR_CFG(3112, 3106, 30, 24, 1, CSI_DATA_LANES_4),
	/* 2072x1166@60fps */
	IS_SENSOR_CFG(2072, 1166, 60, 24, 2, CSI_DATA_LANES_4),
	/* 2072x1166@30fps */
	IS_SENSOR_CFG(2072, 1166, 30, 24, 3, CSI_DATA_LANES_4),
	/* 1296x732@120fps */
	IS_SENSOR_CFG(1296, 732, 120, 24, 4, CSI_DATA_LANES_4),
	/* 1040x586@120fps */
	IS_SENSOR_CFG(1040, 586, 120, 24, 5, CSI_DATA_LANES_4),
};

static struct is_vci vci_module_3m2[] = {
	{
...
static int __init sensor_module_3m2_probe(struct platform_device *pdev)
{
	...
	is_module_parse_dt(dev, sensor_module_3m2_power_setpin);
...
static const struct of_device_id exynos_is_sensor_module_3m2_match[] = {
	{
		.compatible = "samsung,sensor-module-3m2",
	},
	{},
};
MODULE_DEVICE_TABLE(of, exynos_is_sensor_module_3m2_match);

static struct platform_driver sensor_module_3m2_driver = {
	.driver = {
		.name   = "FIMC-IS-SENSOR-MODULE-3M2",
		.owner  = THIS_MODULE,
		.of_match_table = exynos_is_sensor_module_3m2_match,
	}
};

static int __init is_sensor_module_3m2_init(void)
{
	int ret;
...
late_initcall(is_sensor_module_3m2_init);
