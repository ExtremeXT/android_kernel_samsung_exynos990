...
int sensor_ak7372_aperture_init(struct v4l2_subdev *subdev, u32 val)
{
	...
	ret = is_sensor_addr8_write8(client, 0xAE, 0x3B); /* setting mode */
	pos = 511;
	data[0] = pos >> 2 & 0xFF;
	data[1] = pos << 6 & 0xC0;
	ret |= is_sensor_addr8_write8(client, 0x00, data[0]); /* position code */
	ret |= is_sensor_addr8_write8(client, 0x01, data[1]);
	ret |= is_sensor_addr8_write8(client, 0x02, 0x00); /* active mode */
...
int sensor_ak7372_aperture_set_start_value_step1(struct v4l2_subdev *subdev, int value)
{
	...
	ret = is_sensor_addr8_write8(client, 0xA6, 0x7B); /* open mode */
	data[0] = pos >> 2 & 0xFF;
	data[1] = pos << 6 & 0xC0;
	ret |= is_sensor_addr8_write8(client, 0x00, data[0]); /* position code */
	ret |= is_sensor_addr8_write8(client, 0x01, data[1]);
...
int sensor_ak7372_aperture_set_start_value_step2(struct v4l2_subdev *subdev, int value)
{
	...
	ret |= is_sensor_addr8_write8(client, 0xA6, 0x00); /* close code */
	data[0] = pos >> 2 & 0xFF;
	data[1] = pos << 6 & 0xC0;
	ret |= is_sensor_addr8_write8(client, 0x00, data[0]); /* position code */
	ret |= is_sensor_addr8_write8(client, 0x01, data[1]);
...
int sensor_ak7372_aperture_prepare_ois_autotest(struct v4l2_subdev *subdev)
{
	...
	ret = is_sensor_addr8_write8(client, 0xAE, 0x3B);
	ret |= is_sensor_addr8_write8(client, 0x00, 0x7F);
	ret |= is_sensor_addr8_write8(client, 0x01, 0xC0);
	ret |= is_sensor_addr8_write8(client, 0x02, 0x00);
	ret |= is_sensor_addr8_write8(client, 0xA6, 0x7B);
	ret |= is_sensor_addr8_write8(client, 0x00, 0xFF);
	ret |= is_sensor_addr8_write8(client, 0x01, 0xC0);
	usleep_range(10000, 11000);

	ret |= is_sensor_addr8_write8(client, 0xA6, 0x00);
	ret |= is_sensor_addr8_write8(client, 0x00, 0x7F);
	ret |= is_sensor_addr8_write8(client, 0x01, 0xC0);
	usleep_range(15000, 16000);
