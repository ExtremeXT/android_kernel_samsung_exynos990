...
#ifndef IS_SFR_MCSC_V4_0_H
#define IS_SFR_MCSC_V4_0_H
...
enum is_mcsc_reg_name {
	...
	MCSC_R_SCALE_PATH_CTRL,		/* only for EVT0 */
	...
	MCSC_R_TDNR_MODE_SELECTION,		/* only for EVT0 */
	MCSC_R_TDNR_TEMPORAL_WEIGHTS_CALCULATION_CONFIG,		/* only for EVT0 */
	MCSC_R_TDNR_X_GRID_Y,		/* only for EVT0 */
	MCSC_R_TDNR_X_GRID_Y_1,		/* only for EVT0 */
	MCSC_R_TDNR_Y_STD_OFFSET,		/* only for EVT0 */
	MCSC_R_TDNR_Y_STD_SLOPE,		/* only for EVT0 */
	MCSC_R_TDNR_Y_STD_SLOPE_1,		/* only for EVT0 */
	MCSC_R_TDNR_X_GRID_U,		/* only for EVT0 */
	MCSC_R_TDNR_X_GRID_U_1,		/* only for EVT0 */
	MCSC_R_TDNR_U_STD_OFFSET,		/* only for EVT0 */
	MCSC_R_TDNR_U_STD_SLOPE,		/* only for EVT0 */
	MCSC_R_TDNR_U_STD_SLOPE_1,		/* only for EVT0 */
	MCSC_R_TDNR_X_GRID_V,		/* only for EVT0 */
	MCSC_R_TDNR_X_GRID_V_1,		/* only for EVT0 */
	MCSC_R_TDNR_V_STD_OFFSET,		/* only for EVT0 */
	MCSC_R_TDNR_V_STD_SLOPE,		/* only for EVT0 */
	MCSC_R_TDNR_V_STD_SLOPE_1,		/* only for EVT0 */
	MCSC_R_TDNR_TEMPORAL_WIEGHTS_COEFFS,		/* only for EVT0 */
	MCSC_R_TDNR_AUTO_LUT_Y_GAINS,		/* only for EVT0 */
	MCSC_R_TDNR_Y_OFFSET,		/* only for EVT0 */
	MCSC_R_TDNR_AUTO_LUT_UV_GAINS,		/* only for EVT0 */
	MCSC_R_TDNR_UV_OFFSET,		/* only for EVT0 */
	MCSC_R_TDNR_CONSTANT_LUT_COEFFS,		/* only for EVT0 */
	MCSC_R_TDNR_CONSTANT_LUT_COEFFS_1,		/* only for EVT0 */
	MCSC_R_TDNR_TEMPORAL_WEIGHT_REFINE,		/* only for EVT0 */
	MCSC_R_TDNR_Y_MOTION_FLAG_CONFIG,		/* only for EVT0 */
	MCSC_R_TDNR_Y_MOTION_FLAG,		/* only for EVT0 */
	MCSC_R_TDNR_UV_MOTION_FLAG,		/* only for EVT0 */
	MCSC_R_TDNR_COEF_OFFSET,		/* only for EVT0 */
	MCSC_R_TDNR_WEIGHT_ENCODER,		/* only for EVT0 */
	MCSC_R_TDNR_WEIGHT_DECODER,		/* only for EVT0 */
	MCSC_R_TDNR_SPATIAL_DENOISING_CONFIG,		/* only for EVT0 */
	MCSC_R_TDNR_SPATIAL_LUMA_GAINS,		/* only for EVT0 */
	MCSC_R_TDNR_SPATIAL_LUMA_OFFSETS,		/* only for EVT0 */
	MCSC_R_TDNR_SPATIAL_LUMA_OFFSETS_1,		/* only for EVT0 */
	MCSC_R_TDNR_SPATIAL_UV_GAINS,		/* only for EVT0 */
	MCSC_R_TDNR_SPATIAL_UV_OFFSETS,		/* only for EVT0 */
	MCSC_R_TDNR_SPATIAL_UV_OFFSETS_1,		/* only for EVT0 */
	MCSC_R_TDNR_ST_BLENDING_TH,		/* only for EVT0 */
	MCSC_R_TDNR_TEMPORAL_BLEND_THRESHOLDS,		/* only for EVT0 */
	MCSC_R_TDNR_DIMENSIONS,		/* only for EVT0 */
	MCSC_R_TDNR_REG_INTERFACE_VER,		/* only for EVT0 */
	MCSC_R_TDNR_BLOCK_ID_CODE,		/* only for EVT0 */
	MCSC_R_TDNR_ENABLE,		/* only for EVT0 */
	MCSC_R_TDNR_YIC_CTRL,		/* only for EVT0 */
	MCSC_R_TDNR_YIC_ENC_SIZE,		/* only for EVT0 */
	MCSC_R_TDNR_YIC_ENC_BINARY_ERROR_TH,		/* only for EVT0 */
	MCSC_R_TDNR_YIC_DEC_SIZE,		/* only for EVT0 */
	MCSC_R_DJAG_CTRL,
	...
	MCSC_R_WDMADS_DITHER,		/* only for EVT1 */
	...
	MCSC_R_WDMATDNR_BASE_ADDR_1,
	MCSC_R_WDMATDNR_BASE_ADDR_2BIT_0,
	MCSC_R_WDMATDNR_BASE_ADDR_2BIT_1,
	MCSC_R_WDMATDNR_2BIT_STRIDE,
	MCSC_R_WDMATDNR_CRC_RESULT0,
	MCSC_R_WDMATDNR_CRC_RESULT1,
	MCSC_R_WDMATDNR_CRC_2BIT_RESULT0,
	MCSC_R_WDMATDNR_CRC_2BIT_RESULT1,
	MCSC_R_DMA_CLK_GATE_DISABLE,
	MCSC_R_WDMA_SRAM_BASE_0,
	MCSC_R_WDMA_SRAM_BASE_3,
	MCSC_R_WDMA_SRAM_BASE_6,		/* only for EVT0 */
	MCSC_R_WDMA_RGB_CTRL_WDMA0,
	MCSC_R_WDMA_RGB_CTRL_WDMA1,
	MCSC_R_WDMA_RGB_CTRL_WDMA2,
	MCSC_R_WDMA_RGB_CTRL_WDMA3,
	MCSC_R_WDMA_RGB_CTRL_WDMA4,
	...
	MCSC_R_RDMATDNR_IMG_SIZE,		/* only for EVT0 */
	MCSC_R_RDMATDNR_STRIDE,		/* only for EVT0 */
	MCSC_R_RDMATDNR_BASE_ADDR_0,		/* only for EVT0 */
	MCSC_R_RDMATDNR_BASE_ADDR_1,		/* only for EVT0 */
	MCSC_R_RDMATDNR_BASE_ADDR_2BIT_0,		/* only for EVT0 */
	MCSC_R_RDMATDNR_BASE_ADDR_2BIT_1,		/* only for EVT0 */
	MCSC_R_RDMATDNR_2BIT_STRIDE,		/* only for EVT0 */
	MCSC_REG_CNT
};
...
static const struct is_reg mcsc_regs[MCSC_REG_CNT] = {
	...
	{0x0130, "SHADOW_REG_CTRL_0"},
	{0x0134, "SHADOW_MEM_RD_CTRL_0"},
	{0x0138, "SHADOW_MEM_RD_SFR_ADDR_0"},
	{0x013C, "SHADOW_MEM_RD_SFR_DATA_0"},
	...
	{0x0230, "SHADOW_REG_CTRL_1"},
	{0x0234, "SHADOW_MEM_RD_CTRL_1"},
	{0x0238, "SHADOW_MEM_RD_SFR_ADDR_1"},
	{0x023C, "SHADOW_MEM_RD_SFR_DATA_1"},
	{0x0300, "SC0_CTRL"},
	{0x0304, "SC0_SRC_POS"},
	{0x0308, "SC0_SRC_SIZE"},
	{0x030C, "SC0_DST_SIZE"},
	...
	{0x2614, "WDMATDNR_BASE_ADDR_1"},
	{0x261C, "WDMATDNR_BASE_ADDR_2BIT_0"},
	{0x2620, "WDMATDNR_BASE_ADDR_2BIT_1"},
	{0x2624, "WDMATDNR_2BIT_STRIDE"},
	{0x2634, "WDMATDNR_CRC_RESULT0"},
	{0x2638, "WDMATDNR_CRC_RESULT1"},
	{0x2640, "WDMATDNR_CRC_2BIT_RESULT0"},
	{0x2644, "WDMATDNR_CRC_2BIT_RESULT1"},
	{0x2F00, "DMA_CLK_GATE_DISABLE"},
	{0x2F04, "WDMA_SRAM_BASE_0"},
	{0x2F08, "WDMA_SRAM_BASE_3"},
	{0x2F0C, "WDMA_SRAM_BASE_6"},
	{0x2F40, "WDMA_RGB_CTRL_WDMA0"},
	{0x2F44, "WDMA_RGB_CTRL_WDMA1"},
	{0x2F48, "WDMA_RGB_CTRL_WDMA2"},
	{0x2F4C, "WDMA_RGB_CTRL_WDMA3"},
	{0x2F50, "WDMA_RGB_CTRL_WDMA4"},
	{0x2F54, "WDMA_RGB_OFFSET"},
	{0x2F58, "WDMA_RGB_COEF_0"},
	{0x2F5C, "WDMA_RGB_COEF_1"},
	{0x2F60, "WDMA_RGB_COEF_2"},
	{0x2F64, "WDMA_RGB_COEF_3"},
	{0x2F68, "WDMA_RGB_COEF_4"},
	...
	{0x3114, "RDMATDNR_BASE_ADDR_1"},
	{0x311C, "RDMATDNR_BASE_ADDR_2BIT_0"},
	{0x3120, "RDMATDNR_BASE_ADDR_2BIT_1"},
	{0x3124, "RDMATDNR_2BIT_STRIDE"},
};
...
enum is_mcsc_reg_field {
	...
	MCSC_F_WDMATDNR_BASE_ADDR_1,
	MCSC_F_WDMATDNR_BASE_ADDR_2BIT_0,
	MCSC_F_WDMATDNR_BASE_ADDR_2BIT_1,
	MCSC_F_WDMATDNR_2BIT_Y_STRIDE,
	MCSC_F_WDMATDNR_2BIT_C_STRIDE,
	MCSC_F_WDMATDNR_CRC_RESULT0,
	MCSC_F_WDMATDNR_CRC_RESULT1,
	MCSC_F_WDMATDNR_CRC_2BIT_RESULT0,
	MCSC_F_WDMATDNR_CRC_2BIT_RESULT1,
	...
	MCSC_F_RDMATDNR_BASE_ADDR_1,
	MCSC_F_RDMATDNR_BASE_ADDR_2BIT_0,
	MCSC_F_RDMATDNR_BASE_ADDR_2BIT_1,
	MCSC_F_RDMATDNR_2BIT_Y_STRIDE,
	MCSC_F_RDMATDNR_2BIT_C_STRIDE,
	MCSC_REG_FIELD_CNT
};
...
static const struct is_field mcsc_fields[MCSC_REG_FIELD_CNT] = {
	...
	{"TDNR_RDMA_EN", 2, 1, RW, 0x0},	/* SCALE_PATH_CTRL */
	{"TDNR_WDMA_EN", 1, 1, RW, 0x0},	/* SCALE_PATH_CTRL */
	{"TDNR_INPUT_SRC_SEL", 0, 1, RW, 0x0},	/* SCALE_PATH_CTRL */
	{"OTF_OUT_SEL", 0, 3, RW, 0x0}, /* OTF_OUT_PATH_CTRL */
	...
	{"TDNR_RUNNING", 23, 1, RWI, 0x0},	/* SCALER_RUNNING_STATUS */
	...
	{"RDMA_TDNR_BUSY", 9, 1, RWI, 0x0}, /* DMA_RUNNING_STATUS */
	{"RDMA_OTF_BUSY", 8, 1, RWI, 0x0},	/* DMA_RUNNING_STATUS */
	{"WDMA_TDNR_BUSY", 6, 1, RWI, 0x0}, /* DMA_RUNNING_STATUS */
	...
	{"MCSC_VERSION", 0, 16, RWI, 0x0400},	/* SCALER_VERSION */
	...
	{"SC3_H_RATIO", 0, 28, RW, 0x0},	/* SC3_H_RATIO */
	{"SC3_V_RATIO", 0, 28, RW, 0x0},	/* SC3_V_RATIO */
	{"SC3_H_INIT_PHASE_OFFSET", 0, 20, RW, 0x0},	/* SC3_H_INIT_PHASE_OFFSET */
	{"SC3_V_INIT_PHASE_OFFSET", 0, 20, RW, 0x0},	/* SC3_V_INIT_PHASE_OFFSET */
	{"SC3_ROUND_MODE", 0, 1, RW, 0x0},	/* SC3_ROUND_MODE */
	{"SC3_V_COEFF_0B", 16, 11, RW, 0x0},	/* SC3_V_COEFF_0AB */
	...
	{"SC3_V_COEFF_1B", 16, 11, RW, 0x0},	/* SC3_V_COEFF_1AB */
	{"SC3_V_COEFF_1A", 0, 11, RW, 0x0}, /* SC3_V_COEFF_1AB */
	{"SC3_V_COEFF_1D", 16, 11, RW, 0x0},	/* SC3_V_COEFF_1CD */
	{"SC3_V_COEFF_1C", 0, 11, RW, 0x0}, /* SC3_V_COEFF_1CD */
	{"SC3_V_COEFF_2B", 16, 11, RW, 0x0},	/* SC3_V_COEFF_2AB */
	{"SC3_V_COEFF_2A", 0, 11, RW, 0x0}, /* SC3_V_COEFF_2AB */
	{"SC3_V_COEFF_2D", 16, 11, RW, 0x0},	/* SC3_V_COEFF_2CD */
	{"SC3_V_COEFF_2C", 0, 11, RW, 0x0}, /* SC3_V_COEFF_2CD */
	{"SC3_V_COEFF_3B", 16, 11, RW, 0x0},	/* SC3_V_COEFF_3AB */
	{"SC3_V_COEFF_3A", 0, 11, RW, 0x0}, /* SC3_V_COEFF_3AB */
	{"SC3_V_COEFF_3D", 16, 11, RW, 0x0},	/* SC3_V_COEFF_3CD */
	{"SC3_V_COEFF_3C", 0, 11, RW, 0x0}, /* SC3_V_COEFF_3CD */
	{"SC3_V_COEFF_4B", 16, 11, RW, 0x0},	/* SC3_V_COEFF_4AB */
	{"SC3_V_COEFF_4A", 0, 11, RW, 0x0}, /* SC3_V_COEFF_4AB */
	{"SC3_V_COEFF_4D", 16, 11, RW, 0x0},	/* SC3_V_COEFF_4CD */
	{"SC3_V_COEFF_4C", 0, 11, RW, 0x0}, /* SC3_V_COEFF_4CD */
	{"SC3_V_COEFF_5B", 16, 11, RW, 0x0},	/* SC3_V_COEFF_5AB */
	{"SC3_V_COEFF_5A", 0, 11, RW, 0x0}, /* SC3_V_COEFF_5AB */
	{"SC3_V_COEFF_5D", 16, 11, RW, 0x0},	/* SC3_V_COEFF_5CD */
	{"SC3_V_COEFF_5C", 0, 11, RW, 0x0}, /* SC3_V_COEFF_5CD */
	{"SC3_V_COEFF_6B", 16, 11, RW, 0x0},	/* SC3_V_COEFF_6AB */
	{"SC3_V_COEFF_6A", 0, 11, RW, 0x0}, /* SC3_V_COEFF_6AB */
	{"SC3_V_COEFF_6D", 16, 11, RW, 0x0},	/* SC3_V_COEFF_6CD */
	{"SC3_V_COEFF_6C", 0, 11, RW, 0x0}, /* SC3_V_COEFF_6CD */
	{"SC3_V_COEFF_7B", 16, 11, RW, 0x0},	/* SC3_V_COEFF_7AB */
	{"SC3_V_COEFF_7A", 0, 11, RW, 0x0}, /* SC3_V_COEFF_7AB */
	{"SC3_V_COEFF_7D", 16, 11, RW, 0x0},	/* SC3_V_COEFF_7CD */
	{"SC3_V_COEFF_7C", 0, 11, RW, 0x0}, /* SC3_V_COEFF_7CD */
	{"SC3_V_COEFF_8B", 16, 11, RW, 0x0},	/* SC3_V_COEFF_8AB */
	{"SC3_V_COEFF_8A", 0, 11, RW, 0x0}, /* SC3_V_COEFF_8AB */
	{"SC3_V_COEFF_8D", 16, 11, RW, 0x0},	/* SC3_V_COEFF_8CD */
	{"SC3_V_COEFF_8C", 0, 11, RW, 0x0}, /* SC3_V_COEFF_8CD */
	{"SC3_H_COEFF_0B", 16, 11, RW, 0x0},	/* SC3_H_COEFF_0AB */
	{"SC3_H_COEFF_0A", 0, 11, RW, 0x0}, /* SC3_H_COEFF_0AB */
	{"SC3_H_COEFF_0D", 16, 11, RW, 0x0},	/* SC3_H_COEFF_0CD */
	...
	{"SC3_H_COEFF_1B", 16, 11, RW, 0x0},	/* SC3_H_COEFF_1AB */
	{"SC3_H_COEFF_1A", 0, 11, RW, 0x0}, /* SC3_H_COEFF_1AB */
	{"SC3_H_COEFF_1D", 16, 11, RW, 0x0},	/* SC3_H_COEFF_1CD */
	{"SC3_H_COEFF_1C", 0, 11, RW, 0x0}, /* SC3_H_COEFF_1CD */
	{"SC3_H_COEFF_1F", 16, 11, RW, 0x0},	/* SC3_H_COEFF_1EF */
	{"SC3_H_COEFF_1E", 0, 11, RW, 0x0}, /* SC3_H_COEFF_1EF */
	{"SC3_H_COEFF_1H", 16, 11, RW, 0x0},	/* SC3_H_COEFF_1GH */
	{"SC3_H_COEFF_1G", 0, 11, RW, 0x0}, /* SC3_H_COEFF_1GH */
	{"SC3_H_COEFF_2B", 16, 11, RW, 0x0},	/* SC3_H_COEFF_2AB */
	{"SC3_H_COEFF_2A", 0, 11, RW, 0x0}, /* SC3_H_COEFF_2AB */
	{"SC3_H_COEFF_2D", 16, 11, RW, 0x0},	/* SC3_H_COEFF_2CD */
	{"SC3_H_COEFF_2C", 0, 11, RW, 0x0}, /* SC3_H_COEFF_2CD */
	{"SC3_H_COEFF_2F", 16, 11, RW, 0x0},	/* SC3_H_COEFF_2EF */
	{"SC3_H_COEFF_2E", 0, 11, RW, 0x0}, /* SC3_H_COEFF_2EF */
	{"SC3_H_COEFF_2H", 16, 11, RW, 0x0},	/* SC3_H_COEFF_2GH */
	{"SC3_H_COEFF_2G", 0, 11, RW, 0x0}, /* SC3_H_COEFF_2GH */
	{"SC3_H_COEFF_3B", 16, 11, RW, 0x0},	/* SC3_H_COEFF_3AB */
	{"SC3_H_COEFF_3A", 0, 11, RW, 0x0}, /* SC3_H_COEFF_3AB */
	{"SC3_H_COEFF_3D", 16, 11, RW, 0x0},	/* SC3_H_COEFF_3CD */
	{"SC3_H_COEFF_3C", 0, 11, RW, 0x0}, /* SC3_H_COEFF_3CD */
	{"SC3_H_COEFF_3F", 16, 11, RW, 0x0},	/* SC3_H_COEFF_3EF */
	{"SC3_H_COEFF_3E", 0, 11, RW, 0x0}, /* SC3_H_COEFF_3EF */
	{"SC3_H_COEFF_3H", 16, 11, RW, 0x0},	/* SC3_H_COEFF_3GH */
	{"SC3_H_COEFF_3G", 0, 11, RW, 0x0}, /* SC3_H_COEFF_3GH */
	{"SC3_H_COEFF_4B", 16, 11, RW, 0x0},	/* SC3_H_COEFF_4AB */
	{"SC3_H_COEFF_4A", 0, 11, RW, 0x0}, /* SC3_H_COEFF_4AB */
	{"SC3_H_COEFF_4D", 16, 11, RW, 0x0},	/* SC3_H_COEFF_4CD */
	{"SC3_H_COEFF_4C", 0, 11, RW, 0x0}, /* SC3_H_COEFF_4CD */
	{"SC3_H_COEFF_4F", 16, 11, RW, 0x0},	/* SC3_H_COEFF_4EF */
	{"SC3_H_COEFF_4E", 0, 11, RW, 0x0}, /* SC3_H_COEFF_4EF */
	{"SC3_H_COEFF_4H", 16, 11, RW, 0x0},	/* SC3_H_COEFF_4GH */
	{"SC3_H_COEFF_4G", 0, 11, RW, 0x0}, /* SC3_H_COEFF_4GH */
	{"SC3_H_COEFF_5B", 16, 11, RW, 0x0},	/* SC3_H_COEFF_5AB */
	{"SC3_H_COEFF_5A", 0, 11, RW, 0x0}, /* SC3_H_COEFF_5AB */
	{"SC3_H_COEFF_5D", 16, 11, RW, 0x0},	/* SC3_H_COEFF_5CD */
	{"SC3_H_COEFF_5C", 0, 11, RW, 0x0}, /* SC3_H_COEFF_5CD */
	{"SC3_H_COEFF_5F", 16, 11, RW, 0x0},	/* SC3_H_COEFF_5EF */
	{"SC3_H_COEFF_5E", 0, 11, RW, 0x0}, /* SC3_H_COEFF_5EF */
	{"SC3_H_COEFF_5H", 16, 11, RW, 0x0},	/* SC3_H_COEFF_5GH */
	{"SC3_H_COEFF_5G", 0, 11, RW, 0x0}, /* SC3_H_COEFF_5GH */
	{"SC3_H_COEFF_6B", 16, 11, RW, 0x0},	/* SC3_H_COEFF_6AB */
	{"SC3_H_COEFF_6A", 0, 11, RW, 0x0}, /* SC3_H_COEFF_6AB */
	{"SC3_H_COEFF_6D", 16, 11, RW, 0x0},	/* SC3_H_COEFF_6CD */
	{"SC3_H_COEFF_6C", 0, 11, RW, 0x0}, /* SC3_H_COEFF_6CD */
	{"SC3_H_COEFF_6F", 16, 11, RW, 0x0},	/* SC3_H_COEFF_6EF */
	{"SC3_H_COEFF_6E", 0, 11, RW, 0x0}, /* SC3_H_COEFF_6EF */
	{"SC3_H_COEFF_6H", 16, 11, RW, 0x0},	/* SC3_H_COEFF_6GH */
	{"SC3_H_COEFF_6G", 0, 11, RW, 0x0}, /* SC3_H_COEFF_6GH */
	{"SC3_H_COEFF_7B", 16, 11, RW, 0x0},	/* SC3_H_COEFF_7AB */
	{"SC3_H_COEFF_7A", 0, 11, RW, 0x0}, /* SC3_H_COEFF_7AB */
	{"SC3_H_COEFF_7D", 16, 11, RW, 0x0},	/* SC3_H_COEFF_7CD */
	{"SC3_H_COEFF_7C", 0, 11, RW, 0x0}, /* SC3_H_COEFF_7CD */
	{"SC3_H_COEFF_7F", 16, 11, RW, 0x0},	/* SC3_H_COEFF_7EF */
	{"SC3_H_COEFF_7E", 0, 11, RW, 0x0}, /* SC3_H_COEFF_7EF */
	{"SC3_H_COEFF_7H", 16, 11, RW, 0x0},	/* SC3_H_COEFF_7GH */
	{"SC3_H_COEFF_7G", 0, 11, RW, 0x0}, /* SC3_H_COEFF_7GH */
	{"SC3_H_COEFF_8B", 16, 11, RW, 0x0},	/* SC3_H_COEFF_8AB */
	{"SC3_H_COEFF_8A", 0, 11, RW, 0x0}, /* SC3_H_COEFF_8AB */
	{"SC3_H_COEFF_8D", 16, 11, RW, 0x0},	/* SC3_H_COEFF_8CD */
	{"SC3_H_COEFF_8C", 0, 11, RW, 0x0}, /* SC3_H_COEFF_8CD */
	{"SC3_H_COEFF_8F", 16, 11, RW, 0x0},	/* SC3_H_COEFF_8EF */
	{"SC3_H_COEFF_8E", 0, 11, RW, 0x0}, /* SC3_H_COEFF_8EF */
	{"SC3_H_COEFF_8H", 16, 11, RW, 0x0},	/* SC3_H_COEFF_8GH */
	{"SC3_H_COEFF_8G", 0, 11, RW, 0x0}, /* SC3_H_COEFF_8GH */
	...
	{"SC4_H_RATIO", 0, 28, RW, 0x0},	/* SC4_H_RATIO */
	{"SC4_V_RATIO", 0, 28, RW, 0x0},	/* SC4_V_RATIO */
	{"SC4_H_INIT_PHASE_OFFSET", 0, 20, RW, 0x0},	/* SC4_H_INIT_PHASE_OFFSET */
	{"SC4_V_INIT_PHASE_OFFSET", 0, 20, RW, 0x0},	/* SC4_V_INIT_PHASE_OFFSET */
	{"SC4_ROUND_MODE", 0, 1, RW, 0x0},	/* SC4_ROUND_MODE */
	{"SC4_V_COEFF_0B", 16, 11, RW, 0x0},	/* SC4_V_COEFF_0AB */
	...
	{"SC4_V_COEFF_1B", 16, 11, RW, 0x0},	/* SC4_V_COEFF_1AB */
	{"SC4_V_COEFF_1A", 0, 11, RW, 0x0}, /* SC4_V_COEFF_1AB */
	{"SC4_V_COEFF_1D", 16, 11, RW, 0x0},	/* SC4_V_COEFF_1CD */
	{"SC4_V_COEFF_1C", 0, 11, RW, 0x0}, /* SC4_V_COEFF_1CD */
	{"SC4_V_COEFF_2B", 16, 11, RW, 0x0},	/* SC4_V_COEFF_2AB */
	{"SC4_V_COEFF_2A", 0, 11, RW, 0x0}, /* SC4_V_COEFF_2AB */
	{"SC4_V_COEFF_2D", 16, 11, RW, 0x0},	/* SC4_V_COEFF_2CD */
	{"SC4_V_COEFF_2C", 0, 11, RW, 0x0}, /* SC4_V_COEFF_2CD */
	{"SC4_V_COEFF_3B", 16, 11, RW, 0x0},	/* SC4_V_COEFF_3AB */
	{"SC4_V_COEFF_3A", 0, 11, RW, 0x0}, /* SC4_V_COEFF_3AB */
	{"SC4_V_COEFF_3D", 16, 11, RW, 0x0},	/* SC4_V_COEFF_3CD */
	{"SC4_V_COEFF_3C", 0, 11, RW, 0x0}, /* SC4_V_COEFF_3CD */
	{"SC4_V_COEFF_4B", 16, 11, RW, 0x0},	/* SC4_V_COEFF_4AB */
	{"SC4_V_COEFF_4A", 0, 11, RW, 0x0}, /* SC4_V_COEFF_4AB */
	{"SC4_V_COEFF_4D", 16, 11, RW, 0x0},	/* SC4_V_COEFF_4CD */
	{"SC4_V_COEFF_4C", 0, 11, RW, 0x0}, /* SC4_V_COEFF_4CD */
	{"SC4_V_COEFF_5B", 16, 11, RW, 0x0},	/* SC4_V_COEFF_5AB */
	{"SC4_V_COEFF_5A", 0, 11, RW, 0x0}, /* SC4_V_COEFF_5AB */
	{"SC4_V_COEFF_5D", 16, 11, RW, 0x0},	/* SC4_V_COEFF_5CD */
	{"SC4_V_COEFF_5C", 0, 11, RW, 0x0}, /* SC4_V_COEFF_5CD */
	{"SC4_V_COEFF_6B", 16, 11, RW, 0x0},	/* SC4_V_COEFF_6AB */
	{"SC4_V_COEFF_6A", 0, 11, RW, 0x0}, /* SC4_V_COEFF_6AB */
	{"SC4_V_COEFF_6D", 16, 11, RW, 0x0},	/* SC4_V_COEFF_6CD */
	{"SC4_V_COEFF_6C", 0, 11, RW, 0x0}, /* SC4_V_COEFF_6CD */
	{"SC4_V_COEFF_7B", 16, 11, RW, 0x0},	/* SC4_V_COEFF_7AB */
	{"SC4_V_COEFF_7A", 0, 11, RW, 0x0}, /* SC4_V_COEFF_7AB */
	{"SC4_V_COEFF_7D", 16, 11, RW, 0x0},	/* SC4_V_COEFF_7CD */
	{"SC4_V_COEFF_7C", 0, 11, RW, 0x0}, /* SC4_V_COEFF_7CD */
	{"SC4_V_COEFF_8B", 16, 11, RW, 0x0},	/* SC4_V_COEFF_8AB */
	{"SC4_V_COEFF_8A", 0, 11, RW, 0x0}, /* SC4_V_COEFF_8AB */
	{"SC4_V_COEFF_8D", 16, 11, RW, 0x0},	/* SC4_V_COEFF_8CD */
	{"SC4_V_COEFF_8C", 0, 11, RW, 0x0}, /* SC4_V_COEFF_8CD */
	{"SC4_H_COEFF_0B", 16, 11, RW, 0x0},	/* SC4_H_COEFF_0AB */
	{"SC4_H_COEFF_0A", 0, 11, RW, 0x0}, /* SC4_H_COEFF_0AB */
	{"SC4_H_COEFF_0D", 16, 11, RW, 0x0},	/* SC4_H_COEFF_0CD */
	...
	{"SC4_H_COEFF_1B", 16, 11, RW, 0x0},	/* SC4_H_COEFF_1AB */
	{"SC4_H_COEFF_1A", 0, 11, RW, 0x0}, /* SC4_H_COEFF_1AB */
	{"SC4_H_COEFF_1D", 16, 11, RW, 0x0},	/* SC4_H_COEFF_1CD */
	{"SC4_H_COEFF_1C", 0, 11, RW, 0x0}, /* SC4_H_COEFF_1CD */
	{"SC4_H_COEFF_1F", 16, 11, RW, 0x0},	/* SC4_H_COEFF_1EF */
	{"SC4_H_COEFF_1E", 0, 11, RW, 0x0}, /* SC4_H_COEFF_1EF */
	{"SC4_H_COEFF_1H", 16, 11, RW, 0x0},	/* SC4_H_COEFF_1GH */
	{"SC4_H_COEFF_1G", 0, 11, RW, 0x0}, /* SC4_H_COEFF_1GH */
	{"SC4_H_COEFF_2B", 16, 11, RW, 0x0},	/* SC4_H_COEFF_2AB */
	{"SC4_H_COEFF_2A", 0, 11, RW, 0x0}, /* SC4_H_COEFF_2AB */
	{"SC4_H_COEFF_2D", 16, 11, RW, 0x0},	/* SC4_H_COEFF_2CD */
	{"SC4_H_COEFF_2C", 0, 11, RW, 0x0}, /* SC4_H_COEFF_2CD */
	{"SC4_H_COEFF_2F", 16, 11, RW, 0x0},	/* SC4_H_COEFF_2EF */
	{"SC4_H_COEFF_2E", 0, 11, RW, 0x0}, /* SC4_H_COEFF_2EF */
	{"SC4_H_COEFF_2H", 16, 11, RW, 0x0},	/* SC4_H_COEFF_2GH */
	{"SC4_H_COEFF_2G", 0, 11, RW, 0x0}, /* SC4_H_COEFF_2GH */
	{"SC4_H_COEFF_3B", 16, 11, RW, 0x0},	/* SC4_H_COEFF_3AB */
	{"SC4_H_COEFF_3A", 0, 11, RW, 0x0}, /* SC4_H_COEFF_3AB */
	{"SC4_H_COEFF_3D", 16, 11, RW, 0x0},	/* SC4_H_COEFF_3CD */
	{"SC4_H_COEFF_3C", 0, 11, RW, 0x0}, /* SC4_H_COEFF_3CD */
	{"SC4_H_COEFF_3F", 16, 11, RW, 0x0},	/* SC4_H_COEFF_3EF */
	{"SC4_H_COEFF_3E", 0, 11, RW, 0x0}, /* SC4_H_COEFF_3EF */
	{"SC4_H_COEFF_3H", 16, 11, RW, 0x0},	/* SC4_H_COEFF_3GH */
	{"SC4_H_COEFF_3G", 0, 11, RW, 0x0}, /* SC4_H_COEFF_3GH */
	{"SC4_H_COEFF_4B", 16, 11, RW, 0x0},	/* SC4_H_COEFF_4AB */
	{"SC4_H_COEFF_4A", 0, 11, RW, 0x0}, /* SC4_H_COEFF_4AB */
	{"SC4_H_COEFF_4D", 16, 11, RW, 0x0},	/* SC4_H_COEFF_4CD */
	{"SC4_H_COEFF_4C", 0, 11, RW, 0x0}, /* SC4_H_COEFF_4CD */
	{"SC4_H_COEFF_4F", 16, 11, RW, 0x0},	/* SC4_H_COEFF_4EF */
	{"SC4_H_COEFF_4E", 0, 11, RW, 0x0}, /* SC4_H_COEFF_4EF */
	{"SC4_H_COEFF_4H", 16, 11, RW, 0x0},	/* SC4_H_COEFF_4GH */
	{"SC4_H_COEFF_4G", 0, 11, RW, 0x0}, /* SC4_H_COEFF_4GH */
	{"SC4_H_COEFF_5B", 16, 11, RW, 0x0},	/* SC4_H_COEFF_5AB */
	{"SC4_H_COEFF_5A", 0, 11, RW, 0x0}, /* SC4_H_COEFF_5AB */
	{"SC4_H_COEFF_5D", 16, 11, RW, 0x0},	/* SC4_H_COEFF_5CD */
	{"SC4_H_COEFF_5C", 0, 11, RW, 0x0}, /* SC4_H_COEFF_5CD */
	{"SC4_H_COEFF_5F", 16, 11, RW, 0x0},	/* SC4_H_COEFF_5EF */
	{"SC4_H_COEFF_5E", 0, 11, RW, 0x0}, /* SC4_H_COEFF_5EF */
	{"SC4_H_COEFF_5H", 16, 11, RW, 0x0},	/* SC4_H_COEFF_5GH */
	{"SC4_H_COEFF_5G", 0, 11, RW, 0x0}, /* SC4_H_COEFF_5GH */
	{"SC4_H_COEFF_6B", 16, 11, RW, 0x0},	/* SC4_H_COEFF_6AB */
	{"SC4_H_COEFF_6A", 0, 11, RW, 0x0}, /* SC4_H_COEFF_6AB */
	{"SC4_H_COEFF_6D", 16, 11, RW, 0x0},	/* SC4_H_COEFF_6CD */
	{"SC4_H_COEFF_6C", 0, 11, RW, 0x0}, /* SC4_H_COEFF_6CD */
	{"SC4_H_COEFF_6F", 16, 11, RW, 0x0},	/* SC4_H_COEFF_6EF */
	{"SC4_H_COEFF_6E", 0, 11, RW, 0x0}, /* SC4_H_COEFF_6EF */
	{"SC4_H_COEFF_6H", 16, 11, RW, 0x0},	/* SC4_H_COEFF_6GH */
	{"SC4_H_COEFF_6G", 0, 11, RW, 0x0}, /* SC4_H_COEFF_6GH */
	{"SC4_H_COEFF_7B", 16, 11, RW, 0x0},	/* SC4_H_COEFF_7AB */
	{"SC4_H_COEFF_7A", 0, 11, RW, 0x0}, /* SC4_H_COEFF_7AB */
	{"SC4_H_COEFF_7D", 16, 11, RW, 0x0},	/* SC4_H_COEFF_7CD */
	{"SC4_H_COEFF_7C", 0, 11, RW, 0x0}, /* SC4_H_COEFF_7CD */
	{"SC4_H_COEFF_7F", 16, 11, RW, 0x0},	/* SC4_H_COEFF_7EF */
	{"SC4_H_COEFF_7E", 0, 11, RW, 0x0}, /* SC4_H_COEFF_7EF */
	{"SC4_H_COEFF_7H", 16, 11, RW, 0x0},	/* SC4_H_COEFF_7GH */
	{"SC4_H_COEFF_7G", 0, 11, RW, 0x0}, /* SC4_H_COEFF_7GH */
	{"SC4_H_COEFF_8B", 16, 11, RW, 0x0},	/* SC4_H_COEFF_8AB */
	{"SC4_H_COEFF_8A", 0, 11, RW, 0x0}, /* SC4_H_COEFF_8AB */
	{"SC4_H_COEFF_8D", 16, 11, RW, 0x0},	/* SC4_H_COEFF_8CD */
	{"SC4_H_COEFF_8C", 0, 11, RW, 0x0}, /* SC4_H_COEFF_8CD */
	{"SC4_H_COEFF_8F", 16, 11, RW, 0x0},	/* SC4_H_COEFF_8EF */
	{"SC4_H_COEFF_8E", 0, 11, RW, 0x0}, /* SC4_H_COEFF_8EF */
	{"SC4_H_COEFF_8H", 16, 11, RW, 0x0},	/* SC4_H_COEFF_8GH */
	{"SC4_H_COEFF_8G", 0, 11, RW, 0x0}, /* SC4_H_COEFF_8GH */
	...
	{"PC3_CONV420_WEIGHT", 0, 5, RW, 0x0},	/* PC3_CONV420_WEIGHT */
	{"PC3_BCHS_ENABLE", 0, 1, RW, 0x0}, /* PC3_BCHS_CTRL */
	{"PC3_BCHS_YOFFSET", 16, 10, RW, 0x0},	/* PC3_BCHS_BC */
	{"PC3_BCHS_YGAIN", 0, 14, RW, 0x0}, /* PC3_BCHS_BC */
	{"PC3_BCHS_C_GAIN_01", 16, 15, RW, 0x0},	/* PC3_BCHS_HS1 */
	{"PC3_BCHS_C_GAIN_00", 0, 15, RW, 0x0}, /* PC3_BCHS_HS1 */
	{"PC3_BCHS_C_GAIN_11", 16, 15, RW, 0x0},	/* PC3_BCHS_HS2 */
	{"PC3_BCHS_C_GAIN_10", 0, 15, RW, 0x0}, /* PC3_BCHS_HS2 */
	{"PC3_BCHS_Y_CLAMP_MAX", 16, 10, RW, 0x0},	/* PC3_BCHS_CLAMP_Y */
	{"PC3_BCHS_Y_CLAMP_MIN", 0, 10, RW, 0x0},	/* PC3_BCHS_CLAMP_Y */
	{"PC3_BCHS_C_CLAMP_MAX", 16, 10, RW, 0x0},	/* PC3_BCHS_CLAMP_C */
	...
	{"PC4_CONV420_WEIGHT", 0, 5, RW, 0x0},	/* PC4_CONV420_WEIGHT */
	{"PC4_BCHS_ENABLE", 0, 1, RW, 0x0}, /* PC4_BCHS_CTRL */
	{"PC4_BCHS_YOFFSET", 16, 10, RW, 0x0},	/* PC4_BCHS_BC */
	{"PC4_BCHS_YGAIN", 0, 14, RW, 0x0}, /* PC4_BCHS_BC */
	{"PC4_BCHS_C_GAIN_01", 16, 15, RW, 0x0},	/* PC4_BCHS_HS1 */
	{"PC4_BCHS_C_GAIN_00", 0, 15, RW, 0x0}, /* PC4_BCHS_HS1 */
	{"PC4_BCHS_C_GAIN_11", 16, 15, RW, 0x0},	/* PC4_BCHS_HS2 */
	{"PC4_BCHS_C_GAIN_10", 0, 15, RW, 0x0}, /* PC4_BCHS_HS2 */
	{"PC4_BCHS_Y_CLAMP_MAX", 16, 10, RW, 0x0},	/* PC4_BCHS_CLAMP_Y */
	{"PC4_BCHS_Y_CLAMP_MIN", 0, 10, RW, 0x0},	/* PC4_BCHS_CLAMP_Y */
	{"PC4_BCHS_C_CLAMP_MAX", 16, 10, RW, 0x0},	/* PC4_BCHS_CLAMP_C */
	...
	{"TDNR_FIRST_FRAME", 4, 1, RW, 0x1},	/* TDNR_MODE_SELECTION */
	{"TDNR_ON", 0, 1, RW, 0x1}, /* TDNR_MODE_SELECTION */
	...
	{"TDNR_REG_INTERFACE_VER", 0, 16, RWI, 0x7D40}, /* TDNR_REG_INTERFACE_VER */
	{"TDNR_BLOCK_ID_CODE", 0, 32, RWI, 0x16926c00}, /* TDNR_BLOCK_ID_CODE */
	{"TDNR_ENABLE", 0, 1, RW, 0x0}, /* TDNR_ENABLE */
	...
	{"DJAG_PS_H_RATIO", 0, 24, RW, 0x0},	/* DJAG_PS_H_RATIO */
	{"DJAG_PS_V_RATIO", 0, 24, RW, 0x0},	/* DJAG_PS_V_RATIO */
	...
	{"DJAG_PS_ROUND_MODE", 0, 1, RW, 0x0},	/* DJAG_PS_ROUND_MODE */
	{"DJAG_CENTER_WEIGHTED_MEAN_WEIGHT", 18, 3, RW, 0x0},	/* DJAG_XFILTER_DEJAGGING_COEFF */
	{"DJAG_DIAGONAL_HF_BOOST_WEIGHT", 15, 3, RW, 0x0},	/* DJAG_XFILTER_DEJAGGING_COEFF */
	{"DJAG_CENTER_HF_BOOST_WEIGHT", 12, 3, RW, 0x0},	/* DJAG_XFILTER_DEJAGGING_COEFF */
	{"DJAG_XFILTER_HF_BOOST_WEIGHT", 8, 4, RW, 0x0},	/* DJAG_XFILTER_DEJAGGING_COEFF */
	{"DJAG_XFILTER_DEJAGGING_WEIGHT1", 4, 4, RW, 0x0},	/* DJAG_XFILTER_DEJAGGING_COEFF */
	{"DJAG_XFILTER_DEJAGGING_WEIGHT0", 0, 4, RW, 0x0},	/* DJAG_XFILTER_DEJAGGING_COEFF */
	{"DJAG_THRES_1X5_ABSHF", 10, 10, RW, 0x0},	/* DJAG_THRES_1X5_MATCHING */
	{"DJAG_THRES_1X5_MATCHING_SAD", 0, 10, RW, 0x0},	/* DJAG_THRES_1X5_MATCHING */
	{"DJAG_THRES_SHOOTING_NEIGHBOR", 16, 8, RW, 0x0},	/* DJAG_THRES_SHOOTING_DETECT_0 */
	{"DJAG_THRES_SHOOTING_LCR", 8, 8, RW, 0x0}, /* DJAG_THRES_SHOOTING_DETECT_0 */
	{"DJAG_THRES_SHOOTING_LLCRR", 0, 8, RW, 0x0},	/* DJAG_THRES_SHOOTING_DETECT_0 */
	{"DJAG_MIN_MAX_WEIGHT", 16, 4, RW, 0x0},	/* DJAG_THRES_SHOOTING_DETECT_1 */
	{"DJAG_THRES_SHOOTING_UCD", 8, 8, RW, 0x0}, /* DJAG_THRES_SHOOTING_DETECT_1 */
	{"DJAG_THRES_SHOOTING_UUCDD", 0, 8, RW, 0x0},	/* DJAG_THRES_SHOOTING_DETECT_1 */
	{"DJAG_LFSR_SEED_0", 0, 16, RW, 0x0},	/* DJAG_LFSR_SEED_0 */
	{"DJAG_LFSR_SEED_1", 0, 16, RW, 0x0},	/* DJAG_LFSR_SEED_1 */
	{"DJAG_LFSR_SEED_2", 0, 16, RW, 0x0},	/* DJAG_LFSR_SEED_2 */
	{"DJAG_DITHER_VALUE_4", 24, 6, RW, 0x0},	/* DJAG_DITHER_VALUE_04 */
	{"DJAG_DITHER_VALUE_3", 18, 6, RW, 0x0},	/* DJAG_DITHER_VALUE_04 */
	{"DJAG_DITHER_VALUE_2", 12, 6, RW, 0x0},	/* DJAG_DITHER_VALUE_04 */
	{"DJAG_DITHER_VALUE_1", 6, 6, RW, 0x0}, /* DJAG_DITHER_VALUE_04 */
	{"DJAG_DITHER_VALUE_0", 0, 6, RW, 0x0}, /* DJAG_DITHER_VALUE_04 */
	{"DJAG_DITHER_VALUE_8", 18, 6, RW, 0x0},	/* DJAG_DITHER_VALUE_58 */
	{"DJAG_DITHER_VALUE_7", 12, 6, RW, 0x0},	/* DJAG_DITHER_VALUE_58 */
	{"DJAG_DITHER_VALUE_6", 6, 6, RW, 0x0}, /* DJAG_DITHER_VALUE_58 */
	{"DJAG_DITHER_VALUE_5", 0, 6, RW, 0x0}, /* DJAG_DITHER_VALUE_58 */
	{"DJAG_DITHER_THRES", 14, 5, RW, 0x0},	/* DJAG_DITHER_THRES */
	{"DJAG_DITHER_SAT_THRES", 4, 10, RW, 0x0},	/* DJAG_DITHER_THRES */
	{"DJAG_SAT_CTRL", 0, 4, RW, 0x0},	/* DJAG_DITHER_THRES */
	{"DJAG_CP_HF_THRES", 0, 7, RW, 0x0},	/* DJAG_CP_HF_THRES */
	{"DJAG_CP_ARBI_MODE", 24, 2, RW, 0x0},	/* DJAG_CP_ARBI */
	{"DJAG_CP_ARBI_DENOM", 20, 4, RW, 0x0}, /* DJAG_CP_ARBI */
	{"DJAG_CP_ARBI_MAX_COV_SHIFT", 16, 4, RW, 0x0}, /* DJAG_CP_ARBI */
	...
	{"WDMATDNR_BASE_ADDR_1", 0, 32, RW, 0x0},	/* WDMATDNR_BASE_ADDR_1 */
	{"WDMATDNR_BASE_ADDR_2BIT_0", 0, 32, RW, 0x0},	/* WDMATDNR_BASE_ADDR_2BIT_0 */
	{"WDMATDNR_BASE_ADDR_2BIT_1", 0, 32, RW, 0x0},	/* WDMATDNR_BASE_ADDR_2BIT_1 */
	{"WDMATDNR_2BIT_Y_STRIDE", 16, 12, RW, 0x0},	/* WDMATDNR_2BIT_STRIDE */
	{"WDMATDNR_2BIT_C_STRIDE", 0, 12, RW, 0x0}, /* WDMATDNR_2BIT_STRIDE */
	{"WDMATDNR_CRC_RESULT0", 0, 32, RWI, 0xFFFFFFFF},	/* WDMATDNR_CRC_RESULT0 */
	{"WDMATDNR_CRC_RESULT1", 0, 32, RWI, 0xFFFFFFFF},	/* WDMATDNR_CRC_RESULT1 */
	{"WDMATDNR_CRC_2BIT_RESULT0", 0, 32, RWI, 0xFFFFFFFF},	/* WDMATDNR_CRC_2BIT_RESULT0 */
	{"WDMATDNR_CRC_2BIT_RESULT1", 0, 32, RWI, 0xFFFFFFFF},	/* WDMATDNR_CRC_2BIT_RESULT1 */
	{"DMA_CLK_GATE_DISABLE", 0, 1, RW, 0x0},	/* DMA_CLK_GATE_DISABLE */
	...
	{"WDMA5_SRAM_BASE", 20, 10, RW, 0x0},	/* WDMA_SRAM_BASE_3 */
	{"WDMA4_SRAM_BASE", 10, 10, RW, 0x0},	/* WDMA_SRAM_BASE_3 */
	{"WDMA3_SRAM_BASE", 0, 10, RW, 0x0},	/* WDMA_SRAM_BASE_3 */
	{"WDMA6_SRAM_BASE", 0, 10, RW, 0x0},	/* WDMA_SRAM_BASE_6 */
	{"WDMA0_RGB_FORMAT", 1, 2, RW, 0x0},	/* WDMA_RGB_CTRL_WDMA0 */
	{"WDMA0_RGB_EN", 0, 1, RW, 0x0},	/* WDMA_RGB_CTRL_WDMA0 */
	{"WDMA1_RGB_FORMAT", 1, 2, RW, 0x0},	/* WDMA_RGB_CTRL_WDMA1 */
	{"WDMA1_RGB_EN", 0, 1, RW, 0x0},	/* WDMA_RGB_CTRL_WDMA1 */
	{"WDMA2_RGB_FORMAT", 1, 2, RW, 0x0},	/* WDMA_RGB_CTRL_WDMA2 */
	{"WDMA2_RGB_EN", 0, 1, RW, 0x0},	/* WDMA_RGB_CTRL_WDMA2 */
	{"WDMA3_RGB_FORMAT", 1, 2, RW, 0x0},	/* WDMA_RGB_CTRL_WDMA3 */
	{"WDMA3_RGB_EN", 0, 1, RW, 0x0},	/* WDMA_RGB_CTRL_WDMA3 */
	{"WDMA4_RGB_FORMAT", 1, 2, RW, 0x0},	/* WDMA_RGB_CTRL_WDMA4 */
	{"WDMA4_RGB_EN", 0, 1, RW, 0x0},	/* WDMA_RGB_CTRL_WDMA4 */
	...
	{"RDMATDNR_BASE_ADDR_1", 0, 32, RW, 0x0},	/* RDMATDNR_BASE_ADDR_1 */
	{"RDMATDNR_BASE_ADDR_2BIT_0", 0, 32, RW, 0x0},	/* RDMATDNR_BASE_ADDR_2BIT_0 */
	{"RDMATDNR_BASE_ADDR_2BIT_1", 0, 32, RW, 0x0},	/* RDMATDNR_BASE_ADDR_2BIT_1 */
	{"RDMATDNR_2BIT_Y_STRIDE", 16, 12, RW, 0x0},	/* RDMATDNR_2BIT_STRIDE */
	{"RDMATDNR_2BIT_C_STRIDE", 0, 12, RW, 0x0}, /* RDMATDNR_2BIT_STRIDE */
