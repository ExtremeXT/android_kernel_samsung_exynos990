...
#ifndef IS_SFR_VRA_V11_H
#define IS_SFR_VRA_V11_H

#include "is-hw-api-common.h"

enum is_vra_chain0_reg_name {
...
static const struct is_reg vra_chain0_regs[VRA_CHAIN0_REG_CNT] = {
...
static const struct is_field vra_chain0_fields[VRA_CHAIN0_REG_FIELD_CNT] = {
...
static const struct is_reg vra_chain1_regs[VRA_CHAIN1_REG_CNT] = {
...
static const struct is_field vra_chain1_fields[VRA_CHAIN1_REG_FIELD_CNT] = {
	/* 1. field_name 2. bit start 3. bit width 4. access type 5. reset */
