...
#ifndef IS_SFR_ISP_V310_H
#define IS_SFR_ISP_V310_H

#include "is-hw-api-common.h"

enum is_isp_reg_name {
...
static const struct is_reg isp_regs[ISP_REG_CNT] = {
...
static const struct is_field isp_fields[ISP_REG_FIELD_CNT] = {
