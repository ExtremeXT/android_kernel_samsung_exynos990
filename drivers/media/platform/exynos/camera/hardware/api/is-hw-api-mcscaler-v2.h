...
#ifndef IS_HW_API_MCSCALER_V2_H
#define IS_HW_API_MCSCALER_V2_H
...
void is_scaler_set_poly_src_size(void __iomem *base_addr, u32 output_id, u32 pos_x, u32 pos_y, u32 width, u32 height);
...
void is_scaler_set_h_s(void __iomem *base_addr, u32 output_id, u32 c_gain00, u32 c_gain01, u32 c_gain10, u32 c_gain11);
...
void is_scaler_set_wdma_format(void __iomem *base_addr, u32 hw_id, u32 output_id, u32 dma_out_format);
void is_scaler_get_wdma_format(void __iomem *base_addr, u32 output_id, u32 *dma_out_format);
...
void is_scaler_set_wdma_addr(void __iomem *base_addr, u32 output_id, u32 y_addr, u32 cb_addr, u32 cr_addr, int buf_index);
void is_scaler_get_wdma_addr(void __iomem *base_addr, u32 output_id, u32 *y_addr, u32 *cb_addr, u32 *cr_addr, int buf_index);
...
void is_scaler_set_wdma_10bit_type(void __iomem *base_addr, u32 output_id, u32 format, u32 bitwidth, enum exynos_sensor_position sensor_position);
...
/* for tdnr */
void is_scaler_set_tdnr_rdma_addr(void __iomem *base_addr,
...
void is_scaler_set_tdnr_wdma_addr(void __iomem *base_addr,
		enum tdnr_buf_type type, u32 y_addr, u32 cb_addr, u32 cr_addr, int buf_index);
void is_scaler_get_tdnr_wdma_addr(void __iomem *base_addr,
		enum tdnr_buf_type type, u32 *y_addr, u32 *cb_addr, u32 *cr_addr, int buf_index);
...
void is_scaler_set_tdnr_rdma_format(void __iomem *base_addr, enum tdnr_buf_type type, u32 dma_in_format);
void is_scaler_set_tdnr_wdma_format(void __iomem *base_addr, enum tdnr_buf_type type, u32 dma_out_format);
void is_scaler_set_tdnr_rdma_stride(void __iomem *base_addr, enum tdnr_buf_type type, u32 y_stride, u32 uv_stride);
void is_scaler_get_tdnr_rdma_stride(void __iomem *base_addr, enum tdnr_buf_type type, u32 *y_stride, u32 *uv_stride);
void is_scaler_set_tdnr_wdma_stride(void __iomem *base_addr, enum tdnr_buf_type type, u32 y_stride, u32 uv_stride);
void is_scaler_get_tdnr_wdma_stride(void __iomem *base_addr, enum tdnr_buf_type type, u32 *y_stride, u32 *uv_stride);
...
void is_scaler_get_tdnr_image_size(void __iomem *base_addr, u32 *width, u32 *height);
