...
#include "sfr/is-sfr-mcsc-v8_10.h"
#include "is-hw.h"
...
{
	err_hw("Not supported MCSC rdma");
}
...
void is_scaler_set_hwfc_mode(void __iomem *base_addr, u32 hwfc_output_ids)
{
	...
	if (hwfc_output_ids & (1 << MCSC_OUTPUT2))
	...
	if ((hwfc_output_ids & (1 << MCSC_OUTPUT2)) && (hwfc_output_ids & (1 << MCSC_OUTPUT3))) {
