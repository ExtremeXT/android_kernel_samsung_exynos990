...
typedef struct _skinstat {
	bool     info_flag;
	uint32_t face_totalpixelcnt;
	uint16_t face_Yavg;
	uint32_t face_Yover200;
	uint32_t face_Yover230;
	uint32_t face_percent;
	uint16_t Havg;
	uint8_t  Savg;
	uint8_t  Vavg;
	uint32_t Human_x;
	uint32_t Human_y;
	uint32_t Human_width;
	uint32_t Human_height;
} skinstat;
