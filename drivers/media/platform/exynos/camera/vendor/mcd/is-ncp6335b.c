...
#ifdef CONFIG_OF
static int is_ncp6335b_probe(struct i2c_client *client,
				  const struct i2c_device_id *id)
{
	...
	np = of_find_compatible_node(NULL, NULL, "samsung,is_ncp6335b");
	if(np == NULL) {
...
static int is_ncp6335b_remove(struct i2c_client *client)
{
	return 0;
}

static struct of_device_id ncp6335b_dt_ids[] = {
        { .compatible = "samsung,is_ncp6335b",},
        {},
};
...
static struct i2c_driver ncp6335b_driver = {
        ...
        .probe = is_ncp6335b_probe,
        .remove = is_ncp6335b_remove,
