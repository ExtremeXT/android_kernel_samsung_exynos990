...
#ifdef CONFIG_OF
static int is_fan53555_probe(struct i2c_client *client,
				  const struct i2c_device_id *id)
{
	...
	np = of_find_compatible_node(NULL, NULL, "samsung,is_fan53555");
	if(np == NULL) {
...
static int is_fan53555_remove(struct i2c_client *client)
{
	return 0;
}

static struct of_device_id fan53555_dt_ids[] = {
        { .compatible = "samsung,is_fan53555",},
        {},
};
...
static struct i2c_driver fan53555_driver = {
        ...
        .probe = is_fan53555_probe,
        .remove = is_fan53555_remove,
