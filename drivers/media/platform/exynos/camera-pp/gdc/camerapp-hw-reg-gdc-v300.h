...
#ifndef CAMERAPP_SFR_GDC_V300_H
#define CAMERAPP_SFR_GDC_V300_H
...
enum camerapp_gdc_reg_name {
	...
	GDC_R_GDC_COMP_ERRORCONCEAL_MODE,
	GDC_R_GDC_COMP_ERRORCONCEAL_VALUE,
	...
	GDC_R_GDC_RDMA_MON_STATUS0,
	GDC_R_GDC_RDMA_MON_STATUS1,
	GDC_R_GDC_GRID_DX_0,
	GDC_R_GDC_GRID_DY_0,
	GDC_REG_CNT,
};
...
static const struct camerapp_sfr_reg gdc_regs[GDC_REG_CNT] = {
	...
	{0x18, "GDC_DST_2BIT_BASE_LUM"},
	{0x1c, "GDC_DST_2BIT_BASE_CHROMA"},
	{0x20, "WAXI_STRIDE_LUM"},
	{0x24, "WAXI_STRIDE_CHROMA"},
	{0x28, "WAXI_STRIDE_2BIT_LUM"},
	{0x2c, "WAXI_STRIDE_2BIT_CHROMA"},
	{0x30, "GDC_CONFIG"},
	...
	{0x38c, "PXC_STRIDE_2BIT_LUM"},
	{0x390, "PXC_STRIDE_2BIT_CHROMA"},
	{0x400, "PXC_DPB_BASE_LUM"},
	{0x404, "PXC_DPB_BASE_CHROMA"},
	{0x408, "PXC_DPB_2BIT_BASE_LUM"},
	{0x40c, "PXC_DPB_2BIT_BASE_CHROMA"},
	{0x504, "REQ_STOP"},
	...
	{0x558, "GDC_COMP_ERRORCONCEAL_MODE"},
	{0x55c, "GDC_COMP_ERRORCONCEAL_VALUE"},
	...
	{0x578, "GDC_RDMA_MON_STATUS0"},
	{0x57c, "GDC_RDMA_MON_STATUS1"},
...
enum camerapp_gdc_reg_field {
	...
	GDC_F_COMP_ERRORCONCEAL_MODE,
	GDC_F_COMP_ERRORCONCEAL_VALUE,
	GDC_F_WDMA_IMG_CRC,
	...
	GDC_F_RDMA_MON_STATUS0,
	GDC_F_RDMA_MON_STATUS1,
	GDC_F_GRID_DX,
	GDC_F_GRID_DY,
	GDC_REG_FIELD_CNT,
};
...
static const struct camerapp_sfr_field gdc_fields[GDC_REG_FIELD_CNT] = {
	...
	{"GDC_VERSION", 0, 32, RWI, 0x3000000},
	...
	{"DST_COMPRESSOR", 2, 2, RW, 0x0},
	{"SRC_COMPRESSOR", 0, 2, RW, 0x0},
	...
	{"INT_MASK_VOTF_LOSTCONNECT", 2, 1, RW, 0x0},
	{"INT_MASK_COMP_ERROR", 1, 1, RW, 0x0},
	{"INT_MASK_FRAME_END", 0, 1, RW, 0x0},
	{"INT_STATUS_VOTF_LOSTCONNECT", 2, 1, RW, 0x0},
	{"INT_STATUS_COMP_ERROR", 1, 1, RW, 0x0},
	...
	{"COMP_ERRORCONCEAL_MODE", 0, 2, RW, 0x0},
	{"COMP_ERRORCONCEAL_VALUE", 0, 10, RW, 0x0},
	...
	{"WDMA_MON_STATUS0", 0, 32, RWI, 0x14},
	{"WDMA_MON_STATUS1", 0, 32, RWI, 0x14},
	{"RDMA_MON_STATUS0", 0, 32, RWI, 0x0},
	{"RDMA_MON_STATUS1", 0, 32, RWI, 0x7f00},
