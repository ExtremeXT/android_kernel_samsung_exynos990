...
struct pmucal_seq core00_on[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CPUCL0_HCHGEN_CLKMUX_CPU", 0x1d020000, 0x0844, (0x1 << 4), (0x1 << 4), 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_EXT_FUNC, "cluster0_cpu_up", 0, 0, 0x21, 0x0, 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CPUCL0_HCHGEN_CLKMUX_CPU", 0x1d020000, 0x0844, (0x1 << 4), (0x0 << 4), 0, 0, 0, 0),
};
struct pmucal_seq core00_off[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CPUCL0_HCHGEN_CLKMUX_CPU", 0x1d020000, 0x0844, (0x1 << 4), (0x1 << 4), 0, 0, 0, 0),
...
struct pmucal_seq core10_on[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CPUCL1_HCHGEN_CLKMUX_CPU", 0x1d030000, 0x0844, (0x1 << 4), (0x1 << 4), 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_EXT_FUNC, "cluster1_cpu_up", 0, 0, 0x31, 0x0, 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CPUCL1_HCHGEN_CLKMUX_CPU", 0x1d030000, 0x0844, (0x1 << 4), (0x0 << 4), 0, 0, 0, 0),
};
struct pmucal_seq core10_off[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CPUCL1_HCHGEN_CLKMUX_CPU", 0x1d030000, 0x0844, (0x1 << 4), (0x1 << 4), 0, 0, 0, 0),
...
struct pmucal_seq core20_on[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CCMU_IDLE_CON", 0x1d200000, 0x00A8, (0x1 << 0), (0x0 << 0), 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_EXT_FUNC, "cluster2_cpu_up", 0, 0, 0x41, 0x0, 0, 0, 0, 0),
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CCMU_IDLE_CON", 0x1d200000, 0x00A8, (0x1 << 0), (0x1 << 0), 0, 0, 0, 0),
};
struct pmucal_seq core20_off[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CCMU_IDLE_CON", 0x1d200000, 0x00A8, (0x1 << 0), (0x0 << 0), 0, 0, 0, 0),
...
struct pmucal_seq cluster1_status[] = {
	PMUCAL_SEQ_DESC(PMUCAL_READ, "CLUSTER1_NONCPU_STATUS", 0x15860000, 0x1404, (0x1 << 0), 0, 0, 0, 0, 0),
};
struct pmucal_seq cluster2_on[] = {
...
struct pmucal_seq ops_l2flush_on[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER2_NONCPU_OUT", 0x15860000, 0x1620, (0x1 << 15), (0x0 << 15), 0, 0, 0, 0),
};
struct pmucal_seq ops_l2flush_off[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER2_NONCPU_OUT", 0x15860000, 0x1620, (0x1 << 15), (0x1 << 15), 0, 0, 0, 0),
};
struct pmucal_seq ops_l2flush_status[] = {
	PMUCAL_SEQ_DESC(PMUCAL_READ, "CLUSTER2_NONCPU_INT_IN", 0x15860000, 0x1640, (0x1 << 4), 0, 0, 0, 0, 0),
};
struct pmucal_seq ops_l3flush_on[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER2_NONCPU_OUT", 0x15860000, 0x1620, (0x1 << 16), (0x0 << 16), 0, 0, 0, 0),
};
struct pmucal_seq ops_l3flush_off[] = {
	PMUCAL_SEQ_DESC(PMUCAL_WRITE, "CLUSTER2_NONCPU_OUT", 0x15860000, 0x1620, (0x1 << 16), (0x1 << 16), 0, 0, 0, 0),
};
struct pmucal_seq ops_l3flush_status[] = {
	PMUCAL_SEQ_DESC(PMUCAL_READ, "CLUSTER2_NONCPU_INT_IN", 0x15860000, 0x1640, (0x1 << 3), 0, 0, 0, 0, 0),
};
enum pmucal_cpu_corenum {
	CPU_CORE00,
	CPU_CORE01,
...
struct pmucal_cpu pmucal_pmu_ops_list[NUM_PMUCAL_OPTIONS] = {
	[OPS_L2FLUSH] = {
		...
		.on = ops_l2flush_on,
		.off = ops_l2flush_off,
		.status = ops_l2flush_status,
		.num_on = ARRAY_SIZE(ops_l2flush_on),
		.num_off = ARRAY_SIZE(ops_l2flush_off),
		.num_status = ARRAY_SIZE(ops_l2flush_status),
	},
	[OPS_L3FLUSH] = {
		.id = OPS_L3FLUSH,
		.on = ops_l3flush_on,
