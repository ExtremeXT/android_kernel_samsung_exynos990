...
struct dynamic_freq_range d2_freq_range_wb01[] = {
	DEFINE_FREQ_RANGE(10562, 10612, 3, 0),
	DEFINE_FREQ_RANGE(10613, 10691, 1, 0),
	DEFINE_FREQ_RANGE(10692, 10806, 3, 0),
	DEFINE_FREQ_RANGE(10807, 10838, 1, 0),
};

struct dynamic_freq_range d2_freq_range_wb02[] = {
	DEFINE_FREQ_RANGE(9662, 9749, 1, 0),
	DEFINE_FREQ_RANGE(9750, 9837, 3, 0),
	DEFINE_FREQ_RANGE(9838, 9938, 1, 0),
};

struct dynamic_freq_range d2_freq_range_wb03[] = {
	DEFINE_FREQ_RANGE(1162, 1243, 0, 0),
	DEFINE_FREQ_RANGE(1244, 1310, 1, 0),
	DEFINE_FREQ_RANGE(1311, 1381, 3, 0),
	DEFINE_FREQ_RANGE(1382, 1430, 0, 0),
	DEFINE_FREQ_RANGE(1431, 1498, 1, 0),
	DEFINE_FREQ_RANGE(1499, 1513, 2, 0),
};

struct dynamic_freq_range d2_freq_range_wb04[] = {
	DEFINE_FREQ_RANGE(1537, 1588, 0, 0),
	DEFINE_FREQ_RANGE(1589, 1666, 1, 0),
	DEFINE_FREQ_RANGE(1667, 1738, 0, 0),
};

struct dynamic_freq_range d2_freq_range_wb05[] = {
	DEFINE_FREQ_RANGE(4357, 4415, 3, 0),
	DEFINE_FREQ_RANGE(4416, 4458, 2, 0),
};

struct dynamic_freq_range d2_freq_range_wb07[] = {
	DEFINE_FREQ_RANGE(2237, 2263, 1, 0),
	DEFINE_FREQ_RANGE(2264, 2355, 0, 0),
	DEFINE_FREQ_RANGE(2356, 2451, 1, 0),
	DEFINE_FREQ_RANGE(2452, 2547, 2, 0),
	DEFINE_FREQ_RANGE(2548, 2563, 1, 0),
};

struct dynamic_freq_range d2_freq_range_wb08[] = {
	DEFINE_FREQ_RANGE(2937, 3001, 2, 0),
	DEFINE_FREQ_RANGE(3002, 3088, 3, 0),
};
...
struct dynamic_freq_range d2_freq_range_bc10[] = {
	DEFINE_FREQ_RANGE(0, 540, 2, 0),
};


struct dynamic_freq_range d2_freq_range_lb01[] = {
	DEFINE_FREQ_RANGE(0, 126, 3, 0),
	DEFINE_FREQ_RANGE(127, 283, 1, 0),
	DEFINE_FREQ_RANGE(284, 513, 3, 0),
	DEFINE_FREQ_RANGE(514, 599, 1, 0),
};

struct dynamic_freq_range d2_freq_range_lb02[] = {
	DEFINE_FREQ_RANGE(600, 800, 1, 0),
	DEFINE_FREQ_RANGE(801, 976, 3, 0),
	DEFINE_FREQ_RANGE(977, 1177, 1, 0),
	DEFINE_FREQ_RANGE(1178, 1199, 2, 0),
};

struct dynamic_freq_range d2_freq_range_lb03[] = {
	DEFINE_FREQ_RANGE(1200, 1388, 0, 0),
	DEFINE_FREQ_RANGE(1389, 1521, 1, 0),
	DEFINE_FREQ_RANGE(1522, 1664, 3, 0),
	DEFINE_FREQ_RANGE(1665, 1762, 0, 0),
	DEFINE_FREQ_RANGE(1763, 1897, 1, 0),
	DEFINE_FREQ_RANGE(1898, 1949, 2, 0),
};

struct dynamic_freq_range d2_freq_range_lb04[] = {
	DEFINE_FREQ_RANGE(1950, 2076, 3, 0),
	DEFINE_FREQ_RANGE(2077, 2233, 1, 0),
	DEFINE_FREQ_RANGE(2234, 2399, 0, 0),
};


struct dynamic_freq_range d2_freq_range_lb05[] = {
	DEFINE_FREQ_RANGE(2400, 2542, 3, 0),
	DEFINE_FREQ_RANGE(2543, 2649, 1, 0),
};

struct dynamic_freq_range d2_freq_range_lb07[] = {
	DEFINE_FREQ_RANGE(2750, 2827, 1, 0),
	DEFINE_FREQ_RANGE(2828, 3016, 2, 0),
	DEFINE_FREQ_RANGE(3017, 3203, 1, 0),
	DEFINE_FREQ_RANGE(3204, 3395, 2, 0),
	DEFINE_FREQ_RANGE(3396, 3449, 1, 0),
};

struct dynamic_freq_range d2_freq_range_lb08[] = {
	DEFINE_FREQ_RANGE(3450, 3604, 2, 0),
	DEFINE_FREQ_RANGE(3605, 3799, 3, 0),
};

struct dynamic_freq_range d2_freq_range_lb12[] = {
	DEFINE_FREQ_RANGE(5010, 5179, 2, 0),
...
struct dynamic_freq_range d2_freq_range_lb17[] = {
	DEFINE_FREQ_RANGE(5730, 5849, 2, 0),	
};

struct dynamic_freq_range d2_freq_range_lb18[] = {
	DEFINE_FREQ_RANGE(5850, 5999, 3, 0),	
};

struct dynamic_freq_range d2_freq_range_lb19[] = {
	DEFINE_FREQ_RANGE(6000, 6149, 1, 0),	
};

struct dynamic_freq_range d2_freq_range_lb20[] = {
	DEFINE_FREQ_RANGE(6150, 6298, 3, 0),
	DEFINE_FREQ_RANGE(6299, 6449, 2, 0),
};

struct dynamic_freq_range d2_freq_range_lb21[] = {
	DEFINE_FREQ_RANGE(6450, 6582, 2, 0),
	DEFINE_FREQ_RANGE(6583, 6599, 0, 0),
};

struct dynamic_freq_range d2_freq_range_lb25[] = {
	DEFINE_FREQ_RANGE(8040, 8240, 1, 0),
	DEFINE_FREQ_RANGE(8241, 8416, 3, 0),
	DEFINE_FREQ_RANGE(8417, 8617, 1, 0),
	DEFINE_FREQ_RANGE(8618, 8689, 2, 0),
};

struct dynamic_freq_range d2_freq_range_lb26[] = {
	DEFINE_FREQ_RANGE(8690, 8932, 3, 0),
	DEFINE_FREQ_RANGE(8933, 9039, 1, 0),
};

struct dynamic_freq_range d2_freq_range_lb28[] = {
	DEFINE_FREQ_RANGE(9210, 9403, 0, 0),
	DEFINE_FREQ_RANGE(9404, 9517, 2, 0),
	DEFINE_FREQ_RANGE(9518, 9659, 3, 0),
};

struct dynamic_freq_range d2_freq_range_lb29[] = {
	DEFINE_FREQ_RANGE(9660, 9769, 3, 0),
};

struct dynamic_freq_range d2_freq_range_lb30[] = {
	DEFINE_FREQ_RANGE(9770, 9869, 1, 0),
};

struct dynamic_freq_range d2_freq_range_lb32[] = {
	DEFINE_FREQ_RANGE(9920, 10112, 2, 0),
	DEFINE_FREQ_RANGE(10113, 10274, 0, 0),
	DEFINE_FREQ_RANGE(10275, 10359, 1, 0),
};

struct dynamic_freq_range d2_freq_range_lb34[] = {
	DEFINE_FREQ_RANGE(36200, 36349, 1, 0),
};

struct dynamic_freq_range d2_freq_range_lb38[] = {
	DEFINE_FREQ_RANGE(37750, 37950, 1, 0),
	DEFINE_FREQ_RANGE(37951, 38137, 0, 0),
	DEFINE_FREQ_RANGE(38138, 38249, 1, 0),
};

struct dynamic_freq_range d2_freq_range_lb39[] = {
	DEFINE_FREQ_RANGE(38250, 38436, 0, 0),
	DEFINE_FREQ_RANGE(38437, 38574, 1, 0),
	DEFINE_FREQ_RANGE(38575, 38649, 2, 0),
};

struct dynamic_freq_range d2_freq_range_lb40[] = {
	DEFINE_FREQ_RANGE(38650, 38812, 3, 0),
	DEFINE_FREQ_RANGE(38813, 38915, 1, 0),
	DEFINE_FREQ_RANGE(38916, 39121, 0, 0),
	DEFINE_FREQ_RANGE(39122, 39291, 1, 0),
	DEFINE_FREQ_RANGE(39292, 39494, 0, 0),
	DEFINE_FREQ_RANGE(39495, 39649, 1, 0),
};

struct dynamic_freq_range d2_freq_range_lb41[] = {
	DEFINE_FREQ_RANGE(39838, 40029, 0, 0),
	DEFINE_FREQ_RANGE(40030, 40214, 1, 0),
	DEFINE_FREQ_RANGE(40215, 40403, 0, 0),
	DEFINE_FREQ_RANGE(40404, 40590, 1, 0),
	DEFINE_FREQ_RANGE(40591, 40777, 0, 0),
	DEFINE_FREQ_RANGE(40778, 40967, 1, 0),
	DEFINE_FREQ_RANGE(40968, 41156, 2, 0),
	DEFINE_FREQ_RANGE(41157, 41343, 1, 0),
	DEFINE_FREQ_RANGE(41344, 41535, 2, 0),
	DEFINE_FREQ_RANGE(41536, 41589, 1, 0),
};

struct dynamic_freq_range d2_freq_range_lb42[] = {
	DEFINE_FREQ_RANGE(41590, 41772, 1, 0),
	DEFINE_FREQ_RANGE(41773, 41983, 3, 0),
	DEFINE_FREQ_RANGE(41984, 42149, 1, 0),
	DEFINE_FREQ_RANGE(42150, 42371, 3, 0),
	DEFINE_FREQ_RANGE(42372, 42525, 1, 0),
	DEFINE_FREQ_RANGE(42526, 42758, 3, 0),
	DEFINE_FREQ_RANGE(42759, 42902, 1, 0),
	DEFINE_FREQ_RANGE(42903, 43021, 0, 0),
	DEFINE_FREQ_RANGE(43022, 43156, 2, 0),
	DEFINE_FREQ_RANGE(43157, 43278, 1, 0),
	DEFINE_FREQ_RANGE(43279, 43395, 0, 0),
	DEFINE_FREQ_RANGE(43396, 43535, 2, 0),
	DEFINE_FREQ_RANGE(43536, 43589, 1, 0),
};
...
struct dynamic_freq_range d2_freq_range_lb66[] = {
	DEFINE_FREQ_RANGE(66436, 66562, 3, 0),
	DEFINE_FREQ_RANGE(66563, 66719, 1, 0),
	DEFINE_FREQ_RANGE(66720, 66949, 3, 0),
	DEFINE_FREQ_RANGE(66950, 67095, 1, 0),
	DEFINE_FREQ_RANGE(67096, 67312, 0, 0),
	DEFINE_FREQ_RANGE(67313, 67335, 1, 0),
};

struct dynamic_freq_range d2_freq_range_lb71[] = {
	DEFINE_FREQ_RANGE(68586, 68786, 2, 0),
	DEFINE_FREQ_RANGE(68787, 68924, 3, 0),
	DEFINE_FREQ_RANGE(68925, 68935, 0, 0),
};
