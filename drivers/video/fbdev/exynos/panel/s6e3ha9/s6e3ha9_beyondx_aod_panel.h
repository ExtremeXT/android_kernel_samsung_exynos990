/*
 * linux/drivers/video/fbdev/exynos/panel/s6e3ha9/s6e3ha9_beyondx_aod_panel.h
 *
...
#ifndef __S6E3HA9_BEYONDX_AOD_PANEL_H__
#define __S6E3HA9_BEYONDX_AOD_PANEL_H__

#include "s6e3ha9_aod.h"
#include "s6e3ha9_aod_panel.h"

#include "s6e3ha9_beyondx_self_mask_img.h"
...
static void *s6e3ha9_beyondx_utype_aod_self_mask_img_cmdtbl[] = {
	...
	&PKTINFO(s6e3ha9_beyondx_utype_aod_self_mask_img_pkt),
	&PKTINFO(s6e3ha9_aod_reset_sd_path),
	&KEYINFO(s6e3ha9_aod_l2_key_disable),
};

static struct seqinfo s6e3ha9_beyondx_utype_aod_seqtbl[MAX_AOD_SEQ] = {
	[SELF_MASK_IMG_SEQ] = SEQINFO_INIT("self_mask_img", s6e3ha9_beyondx_utype_aod_self_mask_img_cmdtbl),
...
static struct aod_tune s6e3ha9_beyondx_utype_aod = {
	.name = "s6e3ha9_beyondx_utype_aod",
	.nr_seqtbl = ARRAY_SIZE(s6e3ha9_beyondx_utype_aod_seqtbl),
	.seqtbl = s6e3ha9_beyondx_utype_aod_seqtbl,
...
static void *s6e3ha9_beyondx_aod_self_mask_img_cmdtbl[] = {
	&KEYINFO(s6e3ha9_aod_l2_key_enable),
	&PKTINFO(s6e3ha9_aod_self_mask_sd_path),
	&PKTINFO(s6e3ha9_beyondx_aod_self_mask_img_pkt),
	&PKTINFO(s6e3ha9_aod_reset_sd_path),
	&KEYINFO(s6e3ha9_aod_l2_key_disable),
};

static struct seqinfo s6e3ha9_beyondx_aod_seqtbl[MAX_AOD_SEQ] = {
	[SELF_MASK_IMG_SEQ] = SEQINFO_INIT("self_mask_img", s6e3ha9_beyondx_aod_self_mask_img_cmdtbl),
	[SELF_MASK_ENA_SEQ] = SEQINFO_INIT("self_mask_ena", s6e3ha9_aod_self_mask_ena_cmdtbl),
	[SELF_MASK_DIS_SEQ] = SEQINFO_INIT("self_mask_dis", s6e3ha9_aod_self_mask_dis_cmdtbl),
	[ANALOG_IMG_SEQ] = SEQINFO_INIT("analog_img", s6e3ha9_aod_analog_img_cmdtbl),
	[ANALOG_CTRL_SEQ] = SEQINFO_INIT("analog_ctrl", s6e3ha9_aod_analog_init_cmdtbl),
...
static struct aod_tune s6e3ha9_beyondx_aod = {
	.name = "s6e3ha9_beyondx_aod",
	.nr_seqtbl = ARRAY_SIZE(s6e3ha9_beyondx_aod_seqtbl),
	.seqtbl = s6e3ha9_beyondx_aod_seqtbl,
	.nr_maptbl = ARRAY_SIZE(s6e3ha9_aod_maptbl),
	.maptbl = s6e3ha9_aod_maptbl,
	.self_mask_en = true,
};
#endif //__S6E3HA9_BEYONDX_AOD_PANEL_H__
