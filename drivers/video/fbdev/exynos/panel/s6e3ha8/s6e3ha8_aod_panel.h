...
static DEFINE_PANEL_UDELAY(s6e3ha8_aod_self_spsram_sel_delay, 1);
...
static struct maptbl s6e3ha8_aod_maptbl[] = {
	...
	[SELFMOVE_PATTERN_MAPTBL] = DEFINE_2D_MAPTBL(s6e3ha8_aod_self_move_patt_tbl,
		init_common_table, s6e3ha8_getidx_self_pattern, s6e3ha8_copy_selfmove_pattern),
#endif
};
...
static DEFINE_STATIC_PACKET_WITH_OPTION(s6e3ha8_aod_self_mask_img_pkt,
		DSI_PKT_TYPE_WR_SR, STAR_SELF_MASK_IMG, 0, PKT_OPTION_SR_ALIGN_16);
