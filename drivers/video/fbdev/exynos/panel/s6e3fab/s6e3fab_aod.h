/*
 * linux/drivers/video/fbdev/exynos/panel/s6e3fab/s6e3fab_aod.h
 *
...
#ifndef __S6E3FAB_AOD_H__
#define __S6E3FAB_AOD_H__
...
#endif
void s6e3fab_copy_self_mask_ctrl(struct maptbl *tbl, u8 *dst);
void s6e3fab_copy_digital_pos(struct maptbl *tbl, u8 *dst);
void s6e3fab_copy_digital_blink(struct maptbl *tbl, u8 *dst);
void s6e3fab_copy_time(struct maptbl *tbl, u8 *dst);
void s6e3fab_copy_timer_rate(struct maptbl *tbl, u8 *dst);
int s6e3fab_init_self_mask_ctrl(struct maptbl *tbl);

void s6e3fab_copy_icon_grid_on_ctrl(struct maptbl *tbl, u8 *dst);
void s6e3fab_copy_self_move_on_ctrl(struct maptbl *tbl, u8 *dst);
void s6e3fab_copy_analog_pos(struct maptbl *tbl, u8 *dst);
void s6e3fab_copy_analog_en(struct maptbl *tbl, u8 *dst);
void s6e3fab_copy_digital_en(struct maptbl *tbl, u8 *dst);
int s6e3fab_getidx_self_mode_pos(struct maptbl *tbl);
void s6e3fab_copy_self_move_reset(struct maptbl *tbl, u8 *dst);
void s6e3fab_copy_icon_ctrl(struct maptbl *tbl, u8 *dst);
void s6e3fab_copy_digital_color(struct maptbl *tbl, u8 *dst);
void s6e3fab_copy_digital_un_width(struct maptbl *tbl, u8 *dst);
void s6e3fab_copy_partial_mode(struct maptbl *tbl, u8 *dst);
void s6e3fab_copy_partial_area(struct maptbl *tbl, u8 *dst);
void s6e3fab_copy_partial_hlpm(struct maptbl *tbl, u8 *dst);
#ifdef SUPPORT_NORMAL_SELF_MOVE
int s6e3fab_getidx_self_pattern(struct maptbl *tbl);
//void s6e3fab_copy_self_move_enable(struct maptbl *tbl, u8 *dst);
void s6e3fab_copy_self_move_pattern(struct maptbl *tbl, u8 *dst);
#endif
#endif
