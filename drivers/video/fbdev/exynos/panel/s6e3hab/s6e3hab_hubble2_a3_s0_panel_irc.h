...
#ifndef __S6E3HAB_HUBBLE2_PANEL_IRC_H__
#define __S6E3HAB_HUBBLE2_PANEL_IRC_H__
...
#define S6E3HAB_HUBBLE2_HBM_COEF	40		// coef = 0.60, -> 100*(10-0.60)

static u8 irc_buffer[S6E3HAB_IRC_TOTAL_LEN];
static u8 irc_ref_tbl[S6E3HAB_IRC_TOTAL_LEN];

static struct panel_irc_info s6e3hab_hubble2_irc = {
	...
	.hbm_coef = S6E3HAB_HUBBLE2_HBM_COEF,
	.buffer = irc_buffer,
	.ref_tbl = irc_ref_tbl
};

#endif /* __S6E3HAB_HUBBLE2_PANEL_IRC_H__ */
