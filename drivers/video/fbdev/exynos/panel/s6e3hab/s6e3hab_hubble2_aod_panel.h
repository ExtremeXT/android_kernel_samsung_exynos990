/*
 * linux/drivers/video/fbdev/exynos/panel/s6e3hab/s6e3hab_hubble2_aod_panel.h
 *
...
#ifndef __S6E3HAB_HUBBLE2_AOD_PANEL_H__
#define __S6E3HAB_HUBBLE2_AOD_PANEL_H__

#include "s6e3hab_aod.h"
#include "s6e3hab_aod_panel.h"

#include "s6e3hab_hubble2_self_mask_img.h"
...
static struct seqinfo s6e3hab_hubble2_aod_seqtbl[MAX_AOD_SEQ] = {
	[SELF_MASK_IMG_SEQ] = SEQINFO_INIT("self_mask_img", s6e3hab_hubble2_aod_self_mask_img_cmdtbl),
...
static struct aod_tune s6e3hab_hubble2_aod = {
	.name = "s6e3hab_hubble2_aod",
	.nr_seqtbl = ARRAY_SIZE(s6e3hab_hubble2_aod_seqtbl),
	.seqtbl = s6e3hab_hubble2_aod_seqtbl,
	.nr_maptbl = ARRAY_SIZE(s6e3hab_aod_maptbl),
	.maptbl = s6e3hab_aod_maptbl,
	.self_mask_en = true,
};
#endif //__S6E3HAB_HUBBLE2_AOD_PANEL_H__
