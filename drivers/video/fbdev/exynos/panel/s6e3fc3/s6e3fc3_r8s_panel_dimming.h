/*
 * linux/drivers/video/fbdev/exynos/panel/s6e3fc3/s6e3fc3_r8s_panel_dimming.h
 *
...
#ifndef __S6E3FC3_PANEL_DIMMING_H___
#define __S6E3FC3_PANEL_DIMMING_H___
#include "../dimming.h"
...
#define S6E3FC3_HBM_STEP (231)
#define S6E3FC3_TOTAL_STEP (S6E3FC3_NR_STEP + S6E3FC3_HBM_STEP)

static unsigned int r8s_brt_tbl[S6E3FC3_TOTAL_STEP] = {
...
static unsigned int r8s_lum_tbl[S6E3FC3_R8S_TOTAL_NR_LUMINANCE] = {
	/* normal 8x32 */
	2, 2, 3, 3, 4, 4, 6, 6,
	7, 7, 8, 9, 11, 11, 12, 13,
...
static unsigned int r8s_step_cnt_tbl[S6E3FC3_TOTAL_STEP] = {
	[0 ... S6E3FC3_TOTAL_STEP - 1] = 1,
};

struct brightness_table s6e3fc3_r8s_panel_brightness_table = {
	...
	.lum = r8s_lum_tbl,
	.sz_lum = S6E3FC3_R8S_TOTAL_NR_LUMINANCE,
	.sz_ui_lum = S6E3FC3_R8S_NR_LUMINANCE,
	.sz_hbm_lum = S6E3FC3_R8S_NR_HBM_LUMINANCE,
	.sz_ext_hbm_lum = 0,
	.brt_to_step = NULL,
	.sz_brt_to_step = 0,
...
static struct panel_dimming_info s6e3fc3_r8s_panel_dimming_info = {
	.name = "s6e3fc3_r8s",
	.dim_init_info = {
		NULL,
	},
	...
	.brt_tbl = &s6e3fc3_r8s_panel_brightness_table,
	/* dimming parameters */
	.dimming_maptbl = NULL,
	.dim_flash_on = false,
	.hbm_aor = NULL,
