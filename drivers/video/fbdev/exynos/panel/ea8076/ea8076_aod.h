/*
 * linux/drivers/video/fbdev/exynos/panel/ea8076/ea8076_aod.h
 *
...
#ifndef __EA8076_AOD_H__
#define __EA8076_AOD_H__
...
#endif
void ea8076_copy_self_mask_ctrl(struct maptbl *tbl, u8 *dst);
int ea8076_init_self_mask_ctrl(struct maptbl *tbl);
#endif
