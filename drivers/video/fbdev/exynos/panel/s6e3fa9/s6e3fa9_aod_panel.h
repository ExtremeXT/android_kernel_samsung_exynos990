...
static u8 S6E3FA9_AOD_KEY1_ENABLE[] = { 0x9F, 0x5A, 0x5A };
static u8 S6E3FA9_AOD_KEY1_DISABLE[] = { 0x9F, 0xA5, 0xA5 };
...
static DEFINE_PANEL_UDELAY(s6e3fa9_aod_self_mask_checksum_1frame_delay, 16700);
static DEFINE_PANEL_UDELAY(s6e3fa9_aod_self_mask_checksum_2frame_delay, 33400);
...
// --------------------- check sum control ----------------------------
static DEFINE_STATIC_PACKET_WITH_OPTION(s6e3fa9_aod_self_mask_img_pkt,
		DSI_PKT_TYPE_WR_SR, S6E3FA9_CRC_SELF_MASK_IMG, 0, PKT_OPTION_SR_ALIGN_16);
