...
bool check_trace_code(enum kbase_trace_code code)
{
	...
	case KBASE_TRACE_CODE(LSI_WA_EXECUTE):
	case KBASE_TRACE_CODE(LSI_WA_EXECUTE_WAIT_POWERUP):
	case KBASE_TRACE_CODE(LSI_WA_EXECUTE_SERIALIZE):
	case KBASE_TRACE_CODE(LSI_WA_EXECUTE_PARALLEL):
	case KBASE_TRACE_CODE(LSI_WA_EXECUTE_EX_SERIALIZE):
	...
	case KBASE_TRACE_CODE(LSI_GPU_SOFTSTOP):
	case KBASE_TRACE_CODE(LSI_GPU_HARDSTOP):
	case KBASE_TRACE_CODE(LSI_SUSPEND):
	case KBASE_TRACE_CODE(LSI_RESUME):
	case KBASE_TRACE_CODE(LSI_LOAD):
