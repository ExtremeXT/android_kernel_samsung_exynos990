...
int dummy_array[] = {
	...
	KBASE_TRACE_CODE_MAKE_CODE(LSI_LOAD), /* utilization */
	...
	KBASE_TRACE_CODE_MAKE_CODE(LSI_FORCE_POWER_ON), /* IFPM Power on */
	KBASE_TRACE_CODE_MAKE_CODE(LSI_FORCE_POWER_OFF), /* IFPM Power off */
	...
	KBASE_TRACE_CODE_MAKE_CODE(LSI_WA_EXECUTE),
	KBASE_TRACE_CODE_MAKE_CODE(LSI_WA_EXECUTE_WAIT_POWERUP),
	KBASE_TRACE_CODE_MAKE_CODE(LSI_WA_EXECUTE_SERIALIZE),
	KBASE_TRACE_CODE_MAKE_CODE(LSI_WA_EXECUTE_PARALLEL),
	KBASE_TRACE_CODE_MAKE_CODE(LSI_WA_EXECUTE_EX_SERIALIZE),
	KBASE_TRACE_CODE_MAKE_CODE(LSI_GPU_SOFTSTOP),
	KBASE_TRACE_CODE_MAKE_CODE(LSI_GPU_HARDSTOP),
#if 0
};
#endif
