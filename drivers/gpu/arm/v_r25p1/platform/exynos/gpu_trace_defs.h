...
int dummy_array[] = {
	...
	KBASE_KTRACE_CODE_MAKE_CODE(LSI_LOAD), /* utilization */
	...
	KBASE_KTRACE_CODE_MAKE_CODE(LSI_FORCE_POWER_ON), /* IFPM Power on */
	KBASE_KTRACE_CODE_MAKE_CODE(LSI_FORCE_POWER_OFF), /* IFPM Power off */
