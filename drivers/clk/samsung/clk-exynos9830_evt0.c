...
#include "../../soc/samsung/cal-if/exynos9830_evt0/cmucal-vclk.h"
#include "../../soc/samsung/cal-if/exynos9830_evt0/cmucal-node.h"
#include "../../soc/samsung/cal-if/exynos9830_evt0/cmucal-qch.h"
#include "../../soc/samsung/cal-if/exynos9830_evt0/clkout_exynos9830.h"
#include "composite.h"
...
struct init_vclk exynos9830_npu0_hwacg_vclks[] __initdata = {
	...
	HWACG_VCLK(GATE_NPUD_UNIT1, NPUD_UNIT1_QCH, "GATE_NPUD_UNIT1", "UMUX_CLKCMU_NPU0_CPU", 0, VCLK_GATE, NULL),
};

struct init_vclk exynos9830_npu1_hwacg_vclks[] __initdata = {
...
struct init_vclk exynos9830_ssp_hwacg_vclks[] __initdata = {
	...
	HWACG_VCLK(GATE_SS_SSPCORE, SS_SSPCORE_QCH, "GATE_SS_SSPCORE", "UMUX_CLKCMU_SSP_BUS", 0, VCLK_GATE, NULL),
...
struct init_vclk exynos9830_tnr_hwacg_vclks[] __initdata = {
	...
	HWACG_VCLK(GATE_SYSMMU_TNR_QCH_S1, SYSMMU_TNR_QCH_S1, "GATE_SYSMMU_TNR_QCH_S1", "UMUX_CLKCMU_TNR_BUS", 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_SYSMMU_TNR_QCH_S2, SYSMMU_TNR_QCH_S2, "GATE_SYSMMU_TNR_QCH_S2", "UMUX_CLKCMU_TNR_BUS", 0, VCLK_GATE, NULL),
...
struct init_vclk exynos9830_vra_hwacg_vclks[] __initdata = {
	...
	HWACG_VCLK(UMUX_CLKCMU_VRA_STR, MUX_CLKCMU_VRA_STR_USER, "UMUX_CLKCMU_VRA_STR", NULL, 0, 0, NULL),

	HWACG_VCLK(GATE_VRA, VRA_QCH, "GATE_VRA", "UMUX_CLKCMU_VRA_BUS", 0, VCLK_GATE, NULL),
	...
	HWACG_VCLK(GATE_STR, STR_QCH, "GATE_STR", "UMUX_CLKCMU_VRA_STR", 0, VCLK_GATE, NULL),
};
...
struct init_vclk exynos9830_dns_hwacg_vclks[] __initdata = {
	...
	HWACG_VCLK(GATE_DNS, DNS_QCH, "GATE_", "UMUX_CLKCMU_DNS_BUS", 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_DNS_C2COM, DNS_QCH_C2COM, "GATE_DNS_C2COM", "UMUX_CLKCMU_DNS_BUS", 0, VCLK_GATE, NULL),
...
struct init_vclk exynos9830_dnc_hwacg_vclks[] __initdata = {
	...
	HWACG_VCLK(GATE_IP_NPUC_ACLK, IP_NPUC_QCH_ACLK, "GATE_IP_NPUC_ACLK", "UMUX_CLKCMU_DNC_BUS", 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_IP_NPUC_PCLK, IP_NPUC_QCH_PCLK, "GATE_IP_NPUC_PCLK", "UMUX_CLKCMU_DNC_BUS", 0, VCLK_GATE, NULL),
...
struct init_vclk exynos9830_ipp_hwacg_vclks[] __initdata = {
	...
	HWACG_VCLK(GATE_SIPU_IPP_C2, SIPU_IPP_QCH_C2, "GATE_SIPU_IPP_C2", "UMUX_CLKCMU_IPP_BUS", 0, VCLK_GATE, NULL),
...
struct init_vclk exynos9830_mcsc_hwacg_vclks[] __initdata = {
	...
	HWACG_VCLK(UMUX_CLKCMU_MCSC_MEIP, MUX_CLKCMU_MCSC_MEIP_USER, "UMUX_CLKCMU_MCSC_MEIP", NULL, 0, 0, NULL),
	HWACG_VCLK(UMUX_CLKCMU_MCSC_GDC, MUX_CLKCMU_MCSC_GDC_USER, "UMUX_CLKCMU_MCSC_GDC", NULL, 0, 0, NULL),

	HWACG_VCLK(GATE_C2AGENT_MCSC, C2AGENT_MCSC_QCH, "GATE_C2AGENT_MCSC", "UMUX_CLKCMU_MCSC_BUS", 0, VCLK_GATE, NULL),
	...
	HWACG_VCLK(GATE_ITSC, ITSC_QCH, "GATE_ITSC", "UMUX_CLKCMU_MCSC_BUS", 0, VCLK_GATE, NULL),
	...
	HWACG_VCLK(GATE_MEIP, MEIP_QCH, "GATE_MEIP", "UMUX_CLKCMU_MCSC_MEIP", 0, VCLK_GATE, NULL),
	HWACG_VCLK(GATE_MEIP_C2, MEIP_QCH_C2, "GATE_MEIP_C2", "UMUX_CLKCMU_MCSC_MEIP", 0, VCLK_GATE, NULL),
...
struct init_vclk exynos9830_npu0_vclks[] __initdata = {
	VCLK(DOUT_CLK_NPU_BUSP, DIV_CLK_NPU_BUSP, "DOUT_CLK_NPU0_BUSP", 0, 0, NULL),
};

struct init_vclk exynos9830_npu1_vclks[] __initdata = {
...
void __init exynos9830_clk_init(struct device_node *np)
{
	...
	samsung_register_vclk(exynos9830_clk_provider, exynos9830_npu0_hwacg_vclks, ARRAY_SIZE(exynos9830_npu0_hwacg_vclks));
	samsung_register_vclk(exynos9830_clk_provider, exynos9830_npu1_hwacg_vclks, ARRAY_SIZE(exynos9830_npu1_hwacg_vclks));
	...
	samsung_register_vclk(exynos9830_clk_provider, exynos9830_npu0_vclks, ARRAY_SIZE(exynos9830_npu0_vclks));
	samsung_register_vclk(exynos9830_clk_provider, exynos9830_npu1_vclks, ARRAY_SIZE(exynos9830_npu1_vclks));
