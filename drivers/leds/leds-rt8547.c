...
#ifdef CONFIG_PM
static int rt8547_suspend(struct device *dev)
{
	LED_INFO("suspend");
	return 0;
}

static int rt8547_resume(struct device *dev)
{
	LED_INFO("resume");
	return 0;
}
#else
#define rt8547_suspend	NULL
#define rt8547_resume	NULL
#endif

const struct dev_pm_ops rt8547_pm = {
	.suspend = rt8547_suspend,
	.resume = rt8547_resume,
};
